...
#[cfg(feature = "DADisk")]
pub type DADiskAppearedCallback = unsafe extern "C-unwind" fn(&DADisk, *mut c_void);
...
pub type DADiskDescriptionChangedCallback =
    unsafe extern "C-unwind" fn(&DADisk, &CFArray, *mut c_void);
...
#[cfg(feature = "DADisk")]
pub type DADiskDisappearedCallback = unsafe extern "C-unwind" fn(&DADisk, *mut c_void);
...
pub type DADiskMountCallback =
    unsafe extern "C-unwind" fn(&DADisk, Option<&DADissenter>, *mut c_void);
...
impl DADisk {
    ...
    pub unsafe fn mount(
        ...
        callback: Option<DADiskMountCallback>,
        context: *mut c_void,
    ) {
        extern "C-unwind" {
            fn DADiskMount(
...
pub type DADiskMountApprovalCallback =
    unsafe extern "C-unwind" fn(&DADisk, *mut c_void) -> *const DADissenter;
...
impl DADisk {
    ...
    pub unsafe fn rename(
        ...
        callback: Option<DADiskRenameCallback>,
        context: *mut c_void,
    ) {
        extern "C-unwind" {
            fn DADiskRename(
...
impl DADisk {
    ...
    pub unsafe fn unmount(
        ...
        callback: Option<DADiskUnmountCallback>,
        context: *mut c_void,
    ) {
        extern "C-unwind" {
            fn DADiskUnmount(
...
impl DADisk {
    ...
    pub unsafe fn eject(
        ...
        callback: Option<DADiskEjectCallback>,
        context: *mut c_void,
    ) {
        extern "C-unwind" {
            fn DADiskEject(
...
impl DADisk {
    ...
    pub unsafe fn claim(
        ...
        release: Option<DADiskClaimReleaseCallback>,
        release_context: *mut c_void,
        callback: Option<DADiskClaimCallback>,
...
#[cfg(feature = "DADisk")]
pub type DADiskPeekCallback = unsafe extern "C-unwind" fn(&DADisk, *mut c_void);
