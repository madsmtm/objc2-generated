...
impl SecExternalFormat {
    ...
    pub const OpenSSL: Self = Self(1);
    #[doc(alias = "kSecFormatSSH")]
    pub const SSH: Self = Self(2);
    #[doc(alias = "kSecFormatBSAFE")]
    pub const BSAFE: Self = Self(3);
    #[doc(alias = "kSecFormatRawKey")]
    pub const RawKey: Self = Self(4);
    #[doc(alias = "kSecFormatWrappedPKCS8")]
    pub const WrappedPKCS8: Self = Self(5);
    #[doc(alias = "kSecFormatWrappedOpenSSL")]
    pub const WrappedOpenSSL: Self = Self(6);
    #[doc(alias = "kSecFormatWrappedSSH")]
    pub const WrappedSSH: Self = Self(7);
    #[doc(alias = "kSecFormatWrappedLSH")]
    pub const WrappedLSH: Self = Self(8);
    #[doc(alias = "kSecFormatX509Cert")]
    pub const X509Cert: Self = Self(9);
    #[doc(alias = "kSecFormatPEMSequence")]
    pub const PEMSequence: Self = Self(10);
    #[doc(alias = "kSecFormatPKCS7")]
    pub const PKCS7: Self = Self(11);
    #[doc(alias = "kSecFormatPKCS12")]
    pub const PKCS12: Self = Self(12);
    #[doc(alias = "kSecFormatNetscapeCertSequence")]
    pub const NetscapeCertSequence: Self = Self(13);
    #[doc(alias = "kSecFormatSSHv2")]
    pub const SSHv2: Self = Self(14);
}
