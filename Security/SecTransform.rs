...
#[deprecated = "SecTransform is no longer supported"]
#[repr(C)]
pub struct SecTransform {
    inner: [u8; 0],
    _p: UnsafeCell<PhantomData<(*const UnsafeCell<()>, PhantomPinned)>>,
}

cf_type!(
    unsafe impl SecTransform {}
);
#[cfg(feature = "objc2")]
cf_objc2_type!(
    unsafe impl RefEncode<void> for SecTransform {}
);
...
#[deprecated = "SecTransform is no longer supported"]
#[repr(C)]
pub struct SecGroupTransform {
    inner: [u8; 0],
    _p: UnsafeCell<PhantomData<(*const UnsafeCell<()>, PhantomPinned)>>,
}

cf_type!(
    unsafe impl SecGroupTransform {}
);
#[cfg(feature = "objc2")]
cf_objc2_type!(
    unsafe impl RefEncode<void> for SecGroupTransform {}
);

unsafe impl ConcreteType for SecTransform {
    /// Return the CFTypeID for a SecTransform.
    ///
    /// Returns: The CFTypeID
    #[doc(alias = "SecTransformGetTypeID")]
    #[inline]
    fn type_id() -> CFTypeID {
        extern "C-unwind" {
...
unsafe impl ConcreteType for SecGroupTransform {
    /// Return the CFTypeID for a SecTransformGroup.
    ///
    /// Returns: The CFTypeID
    #[doc(alias = "SecGroupTransformGetTypeID")]
    #[inline]
    fn type_id() -> CFTypeID {
        extern "C-unwind" {
...
impl SecTransform {
    ...
    #[doc(alias = "SecTransformCreateGroupTransform")]
    #[deprecated = "SecTransform is no longer supported"]
    #[inline]
    pub unsafe fn new_group_transform() -> CFRetained<SecGroupTransform> {
        extern "C-unwind" {
    ...
    #[deprecated = "SecTransform is no longer supported"]
    #[inline]
    pub unsafe fn connect_transforms(
        &self,
    ...
    #[doc(alias = "SecTransformGetAttribute")]
    #[deprecated = "SecTransform is no longer supported"]
    #[inline]
    pub unsafe fn attribute(&self, key: &CFString) -> Option<CFRetained<CFType>> {
        extern "C-unwind" {
        ...
        let ret = unsafe { SecTransformGetAttribute(self, key) };
        ret.map(|ret| unsafe { CFRetained::retain(ret) })
    }
    ...
    /// was not found.
    #[doc(alias = "SecTransformFindByName")]
    #[deprecated = "SecTransform is no longer supported"]
    #[inline]
