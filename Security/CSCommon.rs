...
/// [Apple's documentation](https://developer.apple.com/documentation/security/errseccsremotesignerfirstslotfull?language=objc)
pub const errSecCSRemoteSignerFirstSlotFull: OSStatus = -66989;
/// [Apple's documentation](https://developer.apple.com/documentation/security/errseccsremotesignersecondslotfull?language=objc)
pub const errSecCSRemoteSignerSecondSlotFull: OSStatus = -66988;
/// [Apple's documentation](https://developer.apple.com/documentation/security/errseccsunsupportedalgorithm?language=objc)
pub const errSecCSUnsupportedAlgorithm: OSStatus = -66987;
/// [Apple's documentation](https://developer.apple.com/documentation/security/errseccsmultipleselfsigning?language=objc)
pub const errSecCSMultipleSelfSigning: OSStatus = -66986;
/// [Apple's documentation](https://developer.apple.com/documentation/security/errseccsdetachedcertificates?language=objc)
pub const errSecCSDetachedCertificates: OSStatus = -66985;
...
extern "C" {
    /// [Apple's documentation](https://developer.apple.com/documentation/security/kseccferrordetachedcertificates?language=objc)
    pub static kSecCFErrorDetachedCertificates: &'static CFString;
}
