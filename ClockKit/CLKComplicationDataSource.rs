...
extern_protocol!(
    ...
    pub unsafe trait CLKComplicationDataSource: NSObjectProtocol + MainThreadOnly {
        ...
        unsafe fn getTimelineEndDateForComplication_withHandler(
            ...
            handler: &block2::Block<'static, fn(*mut NSDate)>,
        );
        ...
        unsafe fn getPrivacyBehaviorForComplication_withHandler(
            &self,
            complication: &CLKComplication,
            handler: &block2::Block<'static, fn(CLKComplicationPrivacyBehavior)>,
        );
        ...
        unsafe fn getTimelineAnimationBehaviorForComplication_withHandler(
            &self,
            complication: &CLKComplication,
            handler: &block2::Block<'static, fn(CLKComplicationTimelineAnimationBehavior)>,
        );
        ...
        unsafe fn getAlwaysOnTemplateForComplication_withHandler(
            &self,
            complication: &CLKComplication,
            handler: &block2::Block<'static, fn(*mut CLKComplicationTemplate)>,
        );
        ...
        unsafe fn getCurrentTimelineEntryForComplication_withHandler(
            &self,
            complication: &CLKComplication,
            handler: &block2::Block<'static, fn(*mut CLKComplicationTimelineEntry)>,
        );
        ...
        unsafe fn getTimelineEntriesForComplication_afterDate_limit_withHandler(
            ...
            date: &NSDate,
            limit: NSUInteger,
            handler: &block2::Block<'static, fn(*mut NSArray<CLKComplicationTimelineEntry>)>,
        );
        ...
        unsafe fn getComplicationDescriptorsWithHandler(
            &self,
            handler: &block2::Block<'static, fn(NonNull<NSArray<CLKComplicationDescriptor>>)>,
        );
        ...
        unsafe fn getSupportedTimeTravelDirectionsForComplication_withHandler(
            &self,
            complication: &CLKComplication,
            handler: &block2::Block<'static, fn(CLKComplicationTimeTravelDirections)>,
        );
