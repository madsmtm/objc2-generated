...
extern "C-unwind" {
    #[cfg(feature = "CFBase")]
    pub fn CFStringGetNameOfEncoding(encoding: CFStringEncoding) -> *mut CFString;
}
...
extern "C-unwind" {
    #[cfg(feature = "CFBase")]
    pub fn CFStringConvertEncodingToIANACharSetName(encoding: CFStringEncoding) -> *mut CFString;
}
