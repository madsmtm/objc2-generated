...
pub type CFReadStreamClientCallBack =
    Option<unsafe extern "C-unwind" fn(CFReadStreamRef, CFStreamEventType, *mut c_void)>;
...
pub type CFWriteStreamClientCallBack =
    Option<unsafe extern "C-unwind" fn(CFWriteStreamRef, CFStreamEventType, *mut c_void)>;
...
extern "C-unwind" {
    ...
    pub fn CFReadStreamCreateWithFile(alloc: CFAllocatorRef, file_url: CFURLRef)
        -> CFReadStreamRef;
}
