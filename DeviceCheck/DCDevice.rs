...
extern_class!(
    ...
    /// ## Overview
    ///
    /// Use the shared instance of the `DCDevice` class to generate a token that identifies a device. Call the [`generateTokenWithCompletionHandler:`](https://developer.apple.com/documentation/devicecheck/dcdevice/generatetoken(completionhandler:)) method to get the token, and then send it to your server:
    ///
    /// ```swift
