...
impl ITLibPlaylistKind {
    /// A standard playlist that the user or iTunes creates, such as _Music_, _Movies_, _Pop Mix_, or _My Awesome Playlist_.
    #[doc(alias = "ITLibPlaylistKindRegular")]
    pub const Regular: Self = Self(0);
    /// A playlist with contents that iTunes generates by evaluating a set of rules, such as _90s Music_ or _Songs from 1999_.
    ...
    /// A playlist folder that the user or iTunes creates, such as _My Playlist Folder_ or _Genius Mixes_.
...
extern_class!(
    ...
    /// ## Overview
    ///
    /// A _playlist_ is a collection of media items (tracks). The user creates and organizes playlists manually, or iTunes automatically generates them. Playlists are media entities. Each contains a unique identifier and a set of properties. Playlists can form a hierarchical structure. In those cases, the [`parentID`](https://developer.apple.com/documentation/ituneslibrary/itlibplaylist/parentid) property of [`ITLibPlaylist`](https://developer.apple.com/documentation/ituneslibrary/itlibplaylist) returns the persistent ID of the parent playlist.
    ///
    ///
