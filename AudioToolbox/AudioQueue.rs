...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/audiotoolbox/audioqueue?language=objc)
...
#[cfg(feature = "objc2")]
unsafe impl RefEncode for AudioQueue {
...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/audiotoolbox/audioqueuetimeline?language=objc)
#[doc(alias = "AudioQueueTimelineRef")]
#[repr(C)]
#[derive(Debug)]
pub struct AudioQueueTimeline {
    inner: [u8; 0],
    _p: UnsafeCell<PhantomData<(*const UnsafeCell<()>, PhantomPinned)>>,
}

#[cfg(feature = "objc2")]
unsafe impl RefEncode for AudioQueueTimeline {
...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/audiotoolbox/audioqueueprocessingtap?language=objc)
#[doc(alias = "AudioQueueProcessingTapRef")]
#[repr(C)]
#[derive(Debug)]
pub struct AudioQueueProcessingTap {
    inner: [u8; 0],
    _p: UnsafeCell<PhantomData<(*const UnsafeCell<()>, PhantomPinned)>>,
}

#[cfg(feature = "objc2")]
unsafe impl RefEncode for AudioQueueProcessingTap {
    const ENCODING_REF: Encoding =
...
pub type AudioQueueOutputCallbackBlock =
    block2::Block<'static, fn(NonNull<AudioQueue>, AudioQueueBufferRef)>;
...
pub type AudioQueueOutputCallback =
    Option<unsafe extern "C-unwind" fn(*mut c_void, NonNull<AudioQueue>, AudioQueueBufferRef)>;
...
pub type AudioQueuePropertyListenerProc =
    Option<unsafe extern "C-unwind" fn(*mut c_void, NonNull<AudioQueue>, AudioQueuePropertyID)>;
...
pub type AudioQueueProcessingTapCallback = Option<
    unsafe extern "C-unwind" fn(
        NonNull<c_void>,
        NonNull<AudioQueueProcessingTap>,
        u32,
        NonNull<AudioTimeStamp>,
...
impl AudioQueue {
    ...
    #[doc(alias = "AudioQueueNewOutputWithDispatchQueue")]
    #[cfg(all(
        feature = "block2",
        feature = "dispatch2",
    ...
    #[inline]
    pub unsafe fn new_output_with_dispatch_queue(
        out_aq: &mut *mut AudioQueue,
        in_format: &AudioStreamBasicDescription,
        in_flags: u32,
    ...
    /// - `out_aq` must be a valid pointer or null.
    /// - `in_callback_dispatch_queue` possibly has additional threading requirements.
    #[doc(alias = "AudioQueueNewInputWithDispatchQueue")]
    #[cfg(all(
        feature = "block2",
        feature = "dispatch2",
        feature = "objc2-core-audio-types"
    ...
    #[inline]
    pub unsafe fn new_input_with_dispatch_queue(
        out_aq: &mut *mut AudioQueue,
        in_format: &AudioStreamBasicDescription,
        in_flags: u32,
        in_callback_dispatch_queue: &DispatchQueue,
    ...
    #[doc(alias = "AudioQueueDispose")]
    #[inline]
    pub unsafe fn dispose(in_aq: NonNull<AudioQueue>, in_immediate: bool) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueDispose(in_aq: NonNull<AudioQueue>, in_immediate: Boolean) -> OSStatus;
        }
    ...
    /// # Safety
    ///
    /// - `in_aq` might need manual memory-management.
    /// - `out_buffer` must be a valid pointer or null.
    #[doc(alias = "AudioQueueAllocateBuffer")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn allocate_buffer(
        ...
        unsafe { AudioQueueAllocateBuffer(self, in_buffer_byte_size, out_buffer) }
    }
    ...
    /// - `in_aq` might need manual memory-management.
    /// - `out_buffer` must be a valid pointer or null.
    #[doc(alias = "AudioQueueAllocateBufferWithPacketDescriptions")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn allocate_buffer_with_packet_descriptions(
        &self,
        in_buffer_byte_size: u32,
    ...
    #[doc(alias = "AudioQueueFreeBuffer")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn free_buffer(&self, in_buffer: AudioQueueBufferRef) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueFreeBuffer(in_aq: &AudioQueue, in_buffer: AudioQueueBufferRef)
                -> OSStatus;
        }
        unsafe { AudioQueueFreeBuffer(self, in_buffer) }
    }
    ...
    #[doc(alias = "AudioQueueEnqueueBuffer")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn enqueue_buffer(
        ...
        unsafe { AudioQueueEnqueueBuffer(self, in_buffer, in_num_packet_descs, in_packet_descs) }
    }
    ...
    #[doc(alias = "AudioQueueEnqueueBufferWithParameters")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn enqueue_buffer_with_parameters(
        &self,
        in_buffer: AudioQueueBufferRef,
        in_num_packet_descs: u32,
        in_packet_descs: *const AudioStreamPacketDescription,
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueStart")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn start(&self, in_start_time: Option<&AudioTimeStamp>) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueStart(
                in_aq: &AudioQueue,
                in_start_time: Option<&AudioTimeStamp>,
        ...
        unsafe { AudioQueueStart(self, in_start_time) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueStop")]
    #[inline]
    pub unsafe fn stop(&self, in_immediate: bool) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueStop(in_aq: &AudioQueue, in_immediate: Boolean) -> OSStatus;
        }
        let in_immediate = in_immediate as _;
        unsafe { AudioQueueStop(self, in_immediate) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueuePause")]
    #[inline]
    pub unsafe fn pause(&self) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueuePause(in_aq: &AudioQueue) -> OSStatus;
        }
        unsafe { AudioQueuePause(self) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueFlush")]
    #[inline]
    pub unsafe fn flush(&self) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueFlush(in_aq: &AudioQueue) -> OSStatus;
        }
        unsafe { AudioQueueFlush(self) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueReset")]
    #[inline]
    pub unsafe fn reset(&self) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueReset(in_aq: &AudioQueue) -> OSStatus;
        }
        unsafe { AudioQueueReset(self) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueGetParameter")]
    #[inline]
    pub unsafe fn parameter(
        ...
        unsafe { AudioQueueGetParameter(self, in_param_id, out_value) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueSetParameter")]
    #[inline]
    pub unsafe fn set_parameter(
        ...
        unsafe { AudioQueueSetParameter(self, in_param_id, in_value) }
    }
    ...
    #[doc(alias = "AudioQueueGetProperty")]
    #[inline]
    pub unsafe fn property(
        ...
        unsafe { AudioQueueGetProperty(self, in_id, out_data, io_data_size) }
    }
    ...
    #[doc(alias = "AudioQueueSetProperty")]
    #[inline]
    pub unsafe fn set_property(
        ...
        unsafe { AudioQueueSetProperty(self, in_id, in_data, in_data_size) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueGetPropertySize")]
    #[inline]
    pub unsafe fn property_size(
        ...
        unsafe { AudioQueueGetPropertySize(self, in_id, out_data_size) }
    }
    ...
    /// - `in_user_data` must be a valid pointer or null.
    #[doc(alias = "AudioQueueAddPropertyListener")]
    #[inline]
    pub unsafe fn add_property_listener(
        ...
        unsafe { AudioQueueAddPropertyListener(self, in_id, in_proc, in_user_data) }
    }
    ...
    /// - `in_proc` must be implemented correctly.
    /// - `in_user_data` must be a valid pointer or null.
    #[doc(alias = "AudioQueueRemovePropertyListener")]
    #[inline]
    pub unsafe fn remove_property_listener(
        &self,
        in_id: AudioQueuePropertyID,
        in_proc: AudioQueuePropertyListenerProc,
        in_user_data: *mut c_void,
        ...
        unsafe { AudioQueueRemovePropertyListener(self, in_id, in_proc, in_user_data) }
    }
    ...
    #[doc(alias = "AudioQueueCreateTimeline")]
    #[inline]
    pub unsafe fn create_timeline(&self, out_timeline: &mut *mut AudioQueueTimeline) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueCreateTimeline(
                in_aq: &AudioQueue,
                out_timeline: &mut *mut AudioQueueTimeline,
            ) -> OSStatus;
        }
        unsafe { AudioQueueCreateTimeline(self, out_timeline) }
    }
    ...
    #[doc(alias = "AudioQueueDisposeTimeline")]
    #[inline]
    pub unsafe fn dispose_timeline(
        in_aq: NonNull<AudioQueue>,
        in_timeline: NonNull<AudioQueueTimeline>,
    ) -> OSStatus {
        extern "C-unwind" {
    ...
    ///
    /// - `in_aq` might need manual memory-management.
    /// - `in_timeline` might need manual memory-management.
    #[doc(alias = "AudioQueueGetCurrentTime")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn current_time(
        &self,
        in_timeline: Option<&AudioQueueTimeline>,
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueDeviceGetCurrentTime")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn device_get_current_time(&self, out_time_stamp: &mut AudioTimeStamp) -> OSStatus {
        extern "C-unwind" {
        ...
        unsafe { AudioQueueDeviceGetCurrentTime(self, out_time_stamp) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueDeviceTranslateTime")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn device_translate_time(
        &self,
        ...
        unsafe { AudioQueueDeviceTranslateTime(self, in_time, out_time) }
    }
    ...
    ///
    /// `in_aq` might need manual memory-management.
    #[doc(alias = "AudioQueueDeviceGetNearestStartTime")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn device_get_nearest_start_time(
        &self,
        ...
        unsafe { AudioQueueDeviceGetNearestStartTime(self, io_requested_start_time, in_flags) }
    }
    ...
    #[doc(alias = "AudioQueueSetOfflineRenderFormat")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn set_offline_render_format(
        &self,
        ...
        unsafe { AudioQueueSetOfflineRenderFormat(self, in_format, in_layout) }
    }
    ...
    #[doc(alias = "AudioQueueOfflineRender")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn offline_render(
        &self,
        ...
        unsafe { AudioQueueOfflineRender(self, in_timestamp, io_buffer, in_number_frames) }
    }
}

impl AudioQueueProcessingTap {
    ...
    #[doc(alias = "AudioQueueProcessingTapNew")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn new(
        in_aq: &AudioQueue,
        ...
        out_aq_tap: &mut *mut AudioQueueProcessingTap,
    ) -> OSStatus {
        extern "C-unwind" {
    ...
    #[doc(alias = "AudioQueueProcessingTapDispose")]
    #[inline]
    pub unsafe fn dispose(in_aq_tap: NonNull<AudioQueueProcessingTap>) -> OSStatus {
        extern "C-unwind" {
            fn AudioQueueProcessingTapDispose(
                in_aq_tap: NonNull<AudioQueueProcessingTap>,
            ) -> OSStatus;
        }
    ...
    /// # Safety
    ///
    /// - `in_aq_tap` might need manual memory-management.
    /// - `io_data` must be a valid pointer.
    #[doc(alias = "AudioQueueProcessingTapGetSourceAudio")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn source_audio(
        ...
        extern "C-unwind" {
            fn AudioQueueProcessingTapGetSourceAudio(
                in_aq_tap: &AudioQueueProcessingTap,
                in_number_frames: u32,
                io_time_stamp: &mut AudioTimeStamp,
                out_flags: &mut AudioQueueProcessingTapFlags,
                out_number_frames: &mut u32,
    ...
    ///
    /// `in_aq_tap` might need manual memory-management.
    #[doc(alias = "AudioQueueProcessingTapGetQueueTime")]
    #[inline]
    pub unsafe fn queue_time(
        &self,
        ...
        unsafe {
            AudioQueueProcessingTapGetQueueTime(self, out_queue_sample_time, out_queue_frame_count)
        }
    }
}
