...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/audiotoolbox/extaudiofile?language=objc)
...
#[cfg(feature = "objc2")]
unsafe impl RefEncode for ExtAudioFile {
...
impl ExtAudioFile {
    ...
    #[doc(alias = "ExtAudioFileOpenURL")]
    #[cfg(feature = "objc2-core-foundation")]
    #[inline]
    pub unsafe fn open_url(in_url: &CFURL, out_ext_audio_file: &mut *mut ExtAudioFile) -> OSStatus {
        extern "C-unwind" {
            fn ExtAudioFileOpenURL(
                in_url: &CFURL,
                out_ext_audio_file: &mut *mut ExtAudioFile,
            ) -> OSStatus;
        }
        unsafe { ExtAudioFileOpenURL(in_url, out_ext_audio_file) }
    }
    ...
    /// - `out_ext_audio_file` must be a valid pointer or null.
    #[doc(alias = "ExtAudioFileWrapAudioFileID")]
    #[cfg(feature = "AudioFile")]
    #[inline]
    pub unsafe fn wrap_audio_file_id(
    ...
    /// - `out_ext_audio_file` must be a valid pointer or null.
    #[doc(alias = "ExtAudioFileCreateWithURL")]
    #[cfg(all(
        feature = "AudioFile",
    ...
    #[doc(alias = "ExtAudioFileDispose")]
    #[inline]
    pub unsafe fn dispose(in_ext_audio_file: NonNull<ExtAudioFile>) -> OSStatus {
        extern "C-unwind" {
            fn ExtAudioFileDispose(in_ext_audio_file: NonNull<ExtAudioFile>) -> OSStatus;
        }
        unsafe { ExtAudioFileDispose(in_ext_audio_file) }
    }
    ...
    /// # Safety
    ///
    /// - `in_ext_audio_file` might need manual memory-management.
    /// - `io_data` must be a valid pointer.
    #[doc(alias = "ExtAudioFileRead")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn read(
        &self,
        ...
        extern "C-unwind" {
            fn ExtAudioFileRead(
                in_ext_audio_file: &ExtAudioFile,
                io_number_frames: &mut u32,
                io_data: NonNull<AudioBufferList>,
            ) -> OSStatus;
        }
        unsafe { ExtAudioFileRead(self, io_number_frames, io_data) }
    }
    ...
    pub unsafe fn write(
        ...
        unsafe { ExtAudioFileWrite(self, in_number_frames, io_data) }
    }
    ...
    #[doc(alias = "ExtAudioFileWriteAsync")]
    #[cfg(feature = "objc2-core-audio-types")]
    #[inline]
    pub unsafe fn write_async(
        ...
        unsafe { ExtAudioFileWriteAsync(self, in_number_frames, io_data) }
    }
    ...
    ///
    /// `in_ext_audio_file` might need manual memory-management.
    #[doc(alias = "ExtAudioFileSeek")]
    #[inline]
    pub unsafe fn seek(&self, in_frame_offset: i64) -> OSStatus {
        extern "C-unwind" {
            fn ExtAudioFileSeek(in_ext_audio_file: &ExtAudioFile, in_frame_offset: i64)
                -> OSStatus;
        }
        unsafe { ExtAudioFileSeek(self, in_frame_offset) }
    }
    ...
    ///
    /// `in_ext_audio_file` might need manual memory-management.
    #[doc(alias = "ExtAudioFileTell")]
    #[inline]
    pub unsafe fn tell(&self, out_frame_offset: &mut i64) -> OSStatus {
        extern "C-unwind" {
            fn ExtAudioFileTell(
                in_ext_audio_file: &ExtAudioFile,
        ...
        unsafe { ExtAudioFileTell(self, out_frame_offset) }
    }
    ...
    ///
    /// `in_ext_audio_file` might need manual memory-management.
    #[doc(alias = "ExtAudioFileGetPropertyInfo")]
    #[inline]
    pub unsafe fn property_info(
        ...
        unsafe { ExtAudioFileGetPropertyInfo(self, in_property_id, out_size, out_writable) }
    }
    ...
    #[doc(alias = "ExtAudioFileGetProperty")]
    #[inline]
    ...
    #[doc(alias = "ExtAudioFileSetProperty")]
    #[inline]
