...
impl CGContext {
    ...
    #[inline]
    pub unsafe fn content_tone_mapping_info(self: &CGContext) -> CGContentToneMappingInfo {
        extern "C-unwind" {
    ...
    #[cfg(feature = "CGToneMapping")]
    #[inline]
    pub unsafe fn set_content_tone_mapping_info(self: &CGContext, info: CGContentToneMappingInfo) {
        extern "C-unwind" {
    ...
    #[inline]
    pub unsafe fn synchronize_attributes(self: &CGContext) {
        extern "C-unwind" {
