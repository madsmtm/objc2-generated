...
extern_protocol!(
    ...
    pub unsafe trait MTLFXFrameInterpolatorBase: NSObjectProtocol {
        ...
        /// # Safety
        ///
        /// - `prev_color_texture` may need to be synchronized.
        /// - `prev_color_texture` may be unretained, you must ensure it is kept alive while in use.
        ...
        /// # Safety
        ///
        /// - `ui_texture` may need to be synchronized.
        /// - `ui_texture` may be unretained, you must ensure it is kept alive while in use.
