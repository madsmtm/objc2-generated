...
/// [Apple's documentation](https://developer.apple.com/documentation/localauthentication/larightstate?language=objc)
// NS_ENUM
#[repr(transparent)]
...
extern_class!(
    /// [Apple's documentation](https://developer.apple.com/documentation/localauthentication/laright?language=objc)
