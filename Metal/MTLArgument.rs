...
extern_methods!(
    ...
    unsafe impl MTLStructMember {
        ...
        pub fn structType(&self) -> Option<Id<Metal::MTLStructType, Shared>>;

        #[cfg(feature = "Metal_MTLArrayType")]
        #[method_id(@__retain_semantics Other arrayType)]
        pub fn arrayType(&self) -> Option<Id<Metal::MTLArrayType, Shared>>;

        #[cfg(feature = "Metal_MTLTextureReferenceType")]
        #[method_id(@__retain_semantics Other textureReferenceType)]
        pub unsafe fn textureReferenceType(
            &self,
        ) -> Option<Id<Metal::MTLTextureReferenceType, Shared>>;

        #[cfg(feature = "Metal_MTLPointerType")]
        #[method_id(@__retain_semantics Other pointerType)]
        pub unsafe fn pointerType(&self) -> Option<Id<Metal::MTLPointerType, Shared>>;
...
extern_methods!(
    ...
    unsafe impl MTLStructType {
        ...
        pub fn members(&self) -> Id<Foundation::NSArray<Metal::MTLStructMember>, Shared>;
        ...
        ) -> Option<Id<Metal::MTLStructMember, Shared>>;
    }
);
...
extern_methods!(
    ...
    unsafe impl MTLArrayType {
        ...
        pub fn elementStructType(&self) -> Option<Id<Metal::MTLStructType, Shared>>;

        #[method_id(@__retain_semantics Other elementArrayType)]
        pub fn elementArrayType(&self) -> Option<Id<Metal::MTLArrayType, Shared>>;
        ...
        pub unsafe fn elementPointerType(&self) -> Option<Id<Metal::MTLPointerType, Shared>>;
    }
);
...
extern_methods!(
    ...
    unsafe impl MTLPointerType {
        ...
        #[cfg(feature = "Metal_MTLStructType")]
        #[method_id(@__retain_semantics Other elementStructType)]
        pub unsafe fn elementStructType(&self) -> Option<Id<Metal::MTLStructType, Shared>>;

        #[cfg(feature = "Metal_MTLArrayType")]
        #[method_id(@__retain_semantics Other elementArrayType)]
        pub unsafe fn elementArrayType(&self) -> Option<Id<Metal::MTLArrayType, Shared>>;
    }
);
...
extern_methods!(
    ...
    unsafe impl MTLArgument {
        ...
        pub fn bufferStructType(&self) -> Option<Id<Metal::MTLStructType, Shared>>;

        #[cfg(feature = "Metal_MTLPointerType")]
        #[method_id(@__retain_semantics Other bufferPointerType)]
        pub unsafe fn bufferPointerType(&self) -> Option<Id<Metal::MTLPointerType, Shared>>;
