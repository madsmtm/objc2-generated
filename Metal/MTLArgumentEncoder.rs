...
extern_protocol!(
    ...
    unsafe impl ProtocolType for MTLArgumentEncoder {
        ...
        pub unsafe fn setArgumentBuffer_offset(
            &self,
            argumentBuffer: Option<&Metal::MTLBuffer>,
            offset: NSUInteger,
        );
        ...
        pub unsafe fn setRenderPipelineState_atIndex(
            &self,
            pipeline: Option<&Metal::MTLRenderPipelineState>,
            index: NSUInteger,
        );
        ...
        pub unsafe fn setComputePipelineState_atIndex(
            &self,
            pipeline: Option<&Metal::MTLComputePipelineState>,
            index: NSUInteger,
        );
        ...
        pub unsafe fn setIndirectCommandBuffer_atIndex(
            &self,
            indirectCommandBuffer: Option<&Metal::MTLIndirectCommandBuffer>,
            index: NSUInteger,
        );
