...
impl MTLLogicalToPhysicalColorAttachmentMap {
    extern_methods!(
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn set_physical_index_for_logical_index(
            &self,
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn get_physical_index_for_logical_index(
            &self,
            logical_index: NSUInteger,
        ) -> NSUInteger;
...
impl MTLRenderPipelineReflection {
    extern_methods!(
        ...
        #[unsafe(method_family = none)]
        pub fn vertex_bindings(&self) -> Retained<NSArray<ProtocolObject<dyn MTLBinding>>>;

        #[cfg(feature = "MTLArgument")]
        #[unsafe(method(fragmentBindings))]
        #[unsafe(method_family = none)]
        pub fn fragment_bindings(&self) -> Retained<NSArray<ProtocolObject<dyn MTLBinding>>>;

        #[cfg(feature = "MTLArgument")]
        #[unsafe(method(tileBindings))]
        #[unsafe(method_family = none)]
        pub fn tile_bindings(&self) -> Retained<NSArray<ProtocolObject<dyn MTLBinding>>>;

        #[cfg(feature = "MTLArgument")]
        #[unsafe(method(objectBindings))]
        #[unsafe(method_family = none)]
        pub fn object_bindings(&self) -> Retained<NSArray<ProtocolObject<dyn MTLBinding>>>;

        #[cfg(feature = "MTLArgument")]
        #[unsafe(method(meshBindings))]
        #[unsafe(method_family = none)]
        pub fn mesh_bindings(&self) -> Retained<NSArray<ProtocolObject<dyn MTLBinding>>>;
...
extern_protocol!(
        ...
        MTLAllocation + NSObjectProtocol + Send + Sync
    {
        ...
        #[unsafe(method_family = new)]
        fn new_render_pipeline_state_with_binary_functions_error(
            &self,
        ...
        #[unsafe(method_family = new)]
        fn new_render_pipeline_descriptor_for_specialization(
            &self,
        ...
        #[unsafe(method_family = none)]
        fn imageblock_sample_length(&self) -> NSUInteger;
        ...
        #[unsafe(method_family = none)]
        fn max_total_threads_per_object_threadgroup(&self) -> NSUInteger;
        ...
        #[unsafe(method_family = none)]
        fn max_total_threads_per_mesh_threadgroup(&self) -> NSUInteger;
        ...
        #[unsafe(method_family = none)]
        fn object_thread_execution_width(&self) -> NSUInteger;
        ...
        #[unsafe(method_family = none)]
        fn mesh_thread_execution_width(&self) -> NSUInteger;
        ...
        #[unsafe(method_family = none)]
        fn max_total_threadgroups_per_mesh_grid(&self) -> NSUInteger;
        ...
        #[unsafe(method_family = new)]
        fn new_render_pipeline_state_with_additional_binary_functions_error(
            &self,
        ...
        #[unsafe(method(shaderValidation))]
        #[unsafe(method_family = none)]
        unsafe fn shader_validation(&self) -> MTLShaderValidation;
...
impl MTLMeshRenderPipelineDescriptor {
    extern_methods!(
        ...
        #[unsafe(method_family = none)]
        pub fn set_mesh_linked_functions(&self, mesh_linked_functions: Option<&MTLLinkedFunctions>);
