...
extern_protocol!(
    ...
    unsafe impl ProtocolType for MTLEvent {
        ...
        pub fn device(&self) -> Option<Id<Metal::MTLDevice, Shared>>;
...
pub type MTLSharedEventNotificationBlock = *mut Block<(NonNull<Metal::MTLSharedEvent>, u64), ()>;
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for MTLSharedEvent {
        ...
        pub unsafe fn newSharedEventHandle(&self) -> Id<Metal::MTLSharedEventHandle, Shared>;
