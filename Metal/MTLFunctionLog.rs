...
extern_protocol!(
    ...
    unsafe impl ProtocolType for MTLFunctionLogDebugLocation {
        ...
        pub unsafe fn functionName(&self) -> Option<Id<Foundation::NSString, Shared>>;
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for MTLFunctionLog {
        ...
        pub unsafe fn function(&self) -> Option<Id<Metal::MTLFunction, Shared>>;

        #[method_id(@__retain_semantics Other debugLocation)]
        pub unsafe fn debugLocation(
            &self,
        ) -> Option<Id<Metal::MTLFunctionLogDebugLocation, Shared>>;
    }
);
