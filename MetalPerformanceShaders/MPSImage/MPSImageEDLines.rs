...
extern_methods!(
    ...
    unsafe impl MPSImageEDLines {
        ...
        #[method_id(@__method_family Init initWithDevice:gaussianSigma:minLineLength:maxLines:detailRatio:gradientThreshold:lineErrorThreshold:mergeLocalityThreshold:)]
