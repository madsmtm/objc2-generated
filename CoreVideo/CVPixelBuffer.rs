...
#[cfg(feature = "CVImageBuffer")]
cf_type!(
    unsafe impl CVPixelBuffer: CVImageBuffer {}
);
...
#[cfg(feature = "CVImageBuffer")]
unsafe impl ConcreteType for CVPixelBuffer {
...
impl CVPixelBuffer {
    ...
    #[inline]
    pub unsafe fn lock_base_address(&self, lock_flags: CVPixelBufferLockFlags) -> CVReturn {
        extern "C-unwind" {
    ...
    #[inline]
    pub unsafe fn unlock_base_address(&self, unlock_flags: CVPixelBufferLockFlags) -> CVReturn {
        extern "C-unwind" {
        ...
        unsafe { CVPixelBufferUnlockBaseAddress(self, unlock_flags) }
    }
    ...
    pub fn is_planar(&self) -> bool {
        ...
        let ret = unsafe { CVPixelBufferIsPlanar(self) };
        ret != 0
    }
    ...
    #[cfg(all(feature = "CVBuffer", feature = "CVImageBuffer"))]
    #[inline]
    pub fn base_address_of_plane(&self, plane_index: usize) -> *mut c_void {
        extern "C-unwind" {
    ...
    #[doc(alias = "CVPixelBufferGetExtendedPixels")]
    #[cfg(all(feature = "CVBuffer", feature = "CVImageBuffer"))]
    #[inline]
    pub fn extended_pixels(
        &self,
    ...
    ///
    /// Parameter `pixelBuffer`: Target PixelBuffer.
    #[doc(alias = "CVPixelBufferFillExtendedPixels")]
    #[cfg(all(feature = "CVBuffer", feature = "CVImageBuffer", feature = "CVReturn"))]
    #[inline]
    pub fn fill_extended_pixels(&self) -> CVReturn {
        ...
        unsafe { CVPixelBufferFillExtendedPixels(self) }
    }
    ...
    ///
    /// Parameter `pixelBuffer`: Target PixelBuffer.
    #[doc(alias = "CVPixelBufferCopyCreationAttributes")]
    #[cfg(all(feature = "CVBuffer", feature = "CVImageBuffer"))]
    #[inline]
    pub fn creation_attributes(&self) -> CFRetained<CFDictionary<CFString, CFType>> {
        extern "C-unwind" {
            fn CVPixelBufferCopyCreationAttributes(
                pixel_buffer: &CVPixelBuffer,
            ) -> Option<NonNull<CFDictionary<CFString, CFType>>>;
        }
        let ret = unsafe { CVPixelBufferCopyCreationAttributes(self) };
        let ret =
    ...
    #[doc(alias = "CVPixelBufferIsCompatibleWithAttributes")]
    #[cfg(all(feature = "CVBuffer", feature = "CVImageBuffer"))]
    #[inline]
    pub unsafe fn is_compatible_with_attributes(
        &self,
        ...
        let ret = unsafe { CVPixelBufferIsCompatibleWithAttributes(self, attributes) };
        ret != 0
    }
}
