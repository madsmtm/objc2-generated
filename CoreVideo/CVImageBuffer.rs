...
#[cfg(feature = "CVBuffer")]
cf_type!(
    unsafe impl CVImageBuffer: CVBuffer {}
);
...
impl CVImageBuffer {
    ...
    #[cfg(feature = "CVBuffer")]
    #[inline]
    pub fn encoded_size(&self) -> CGSize {
        extern "C-unwind" {
    ...
    #[cfg(feature = "CVBuffer")]
    #[inline]
    pub fn display_size(&self) -> CGSize {
        extern "C-unwind" {
    ...
    pub fn is_flipped(&self) -> bool {
        ...
        let ret = unsafe { CVImageBufferIsFlipped(self) };
        ret != 0
    }
    ...
    #[doc(alias = "CVImageBufferGetColorSpace")]
    ...
    pub fn color_space(&self) -> Option<CFRetained<CGColorSpace>> {
        ...
        let ret = unsafe { CVImageBufferGetColorSpace(self) };
        ret.map(|ret| unsafe { CFRetained::retain(ret) })
    }
    ...
    #[doc(alias = "CVImageBufferCreateColorSpaceFromAttachments")]
    #[cfg(feature = "objc2-core-graphics")]
    #[inline]
    pub unsafe fn new_color_space_from_attachments(
