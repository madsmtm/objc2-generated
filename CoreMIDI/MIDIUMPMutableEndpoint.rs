...
extern_methods!(
    ...
    unsafe impl MIDIUMPMutableEndpoint {
        ...
        #[method_id(@__retain_semantics Other mutableFunctionBlocks)]
        ...
        #[method_id(@__retain_semantics Init initWithName:deviceInfo:productInstanceID:MIDIProtocol:destinationCallback:)]
