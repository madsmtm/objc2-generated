...
extern_methods!(
    ...
    unsafe impl MIDIUMPMutableEndpoint {
        ...
        #[method_id(@__method_family Other mutableFunctionBlocks)]
        ...
        #[method_id(@__method_family Init initWithName:deviceInfo:productInstanceID:MIDIProtocol:destinationCallback:)]
