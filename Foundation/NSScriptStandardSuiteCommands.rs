...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nssaveoptions?language=objc)
// NS_ENUM
#[repr(transparent)]
...
extern_class!(
    ...
    ///
    /// When an instance of `NSCloneCommand` is executed, it clones the specified objects by sending them
    /// <doc
    /// ://com.apple.documentation/documentation/objectivec/nsobject-swift.class/copywithzone:> messages.
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsclonecommand?language=objc)
...
extern_class!(
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsclosecommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nscountcommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    ///
    /// If an `NSCreateCommand` object with no argument corresponding to the `at` parameter is executed (for example, `tell application "Mail" to make new mailbox with properties {name:"testFolder"}`), and the receiver of the command (not necessarily the application object) has a to-many relationship to objects of the class to be instantiated, and the class description for the receiving class returns
    /// <doc
    /// ://com.apple.documentation/documentation/swift/false> when sent an `isLocationRequiredToCreateForKey:` message, the `NSCreateCommand` object creates a new object and sends the receiver an
    /// <doc
    /// ://com.apple.documentation/documentation/objectivec/nsobject-swift.class/insertvalue(_:at:inpropertywithkey:)> message to place the new object in the container. This is part of Cocoa's scripting support for inserting newly-created objects into containers without explicitly specifying a location.
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nscreatecommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsdeletecommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    /// - [Cocoa Scripting Guide](https://developer.apple.com/library/archive/documentation/Cocoa/Conceptual/ScriptableCocoaApplications/SApps_intro/SAppsIntro.html#//apple_ref/doc/uid/TP40002164)
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsexistscommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    /// - [Cocoa Scripting Guide](https://developer.apple.com/library/archive/documentation/Cocoa/Conceptual/ScriptableCocoaApplications/SApps_intro/SAppsIntro.html#//apple_ref/doc/uid/TP40002164)
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsgetcommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsmovecommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsquitcommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
...
extern_class!(
    ...
    ///
    /// `NSSetCommand` uses available scripting class descriptions to determine whether it should set a value for an attribute (or property), or set a value for all elements (to-many objects). For the latter, it invokes
    /// <doc
    /// ://com.apple.documentation/documentation/objectivec/nsobject-swift.class/replacevalue(at:inpropertywithkey:withvalue:)>; for the former, it invokes
    /// <doc
    /// ://com.apple.documentation/documentation/objectivec/nsobject-swift.class/setvalue(_:forkey:)> (or, if the receiver overrides
    /// <doc
    /// ://com.apple.documentation/documentation/objectivec/nsobject-swift.class/takevalue(_:forkey:)>, it invokes that method, to support backward binary compatibility.)
    ///
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nssetcommand?language=objc)
    #[unsafe(super(NSScriptCommand, NSObject))]
    #[derive(Debug, PartialEq, Eq, Hash)]
    #[cfg(feature = "NSScriptCommand")]
