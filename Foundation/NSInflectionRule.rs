...
extern_methods!(
    ...
    unsafe impl NSInflectionRule {
        ...
        pub unsafe fn automaticRule() -> Id<Foundation::NSInflectionRule, Shared>;
    }
);
...
extern_methods!(
    ...
    unsafe impl NSInflectionRuleExplicit {
        ...
        pub unsafe fn initWithMorphology(
            ...
            morphology: &Foundation::NSMorphology,
        ) -> Id<Self, Shared>;

        #[cfg(feature = "Foundation_NSMorphology")]
        #[method_id(@__retain_semantics Other morphology)]
        pub unsafe fn morphology(&self) -> Id<Foundation::NSMorphology, Shared>;
    }
);
...
extern_methods!(
    ...
    unsafe impl NSInflectionRule {
        ...
        pub unsafe fn canInflectLanguage(language: &Foundation::NSString) -> bool;
