...
extern_class!(
    ...
    ///
    /// > Important:
    /// > The Swift overlay to the Foundation framework provides the ``PersonNameComponents`` structure, which bridges to the ``NSPersonNameComponents`` class. For more information about value types, see
    /// <doc
    ...
    ///
    /// > Note:
    /// > `NSPersonNameComponents` represents only the components of a name. To represent contact information, such as postal addresses or phone numbers, in addition to a personal name, use
    /// <doc
    /// ://com.apple.documentation/documentation/contacts/cncontact> or
    /// <doc
    /// ://com.apple.documentation/documentation/contacts/cnmutablecontact> instead.
    ///
    /// ### Name Components
    ///
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nspersonnamecomponents?language=objc)
