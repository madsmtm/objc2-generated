...
extern_methods!(
    ...
    unsafe impl NSScanner {
        ...
        pub unsafe fn charactersToBeSkipped(
            &self,
        ...
        pub unsafe fn setCharactersToBeSkipped(
            &self,
            charactersToBeSkipped: Option<&Foundation::NSCharacterSet>,
        );
...
extern_methods!(
    ...
    unsafe impl NSScanner {
        ...
        pub unsafe fn scanString_intoString(
            &self,
            string: &Foundation::NSString,
            result: *mut *mut Foundation::NSString,
        ) -> bool;
        ...
        pub unsafe fn scannerWithString(string: &Foundation::NSString) -> Id<Self, Shared>;

        #[cfg(feature = "Foundation_NSString")]
        #[method_id(@__retain_semantics Other localizedScannerWithString:)]
        pub unsafe fn localizedScannerWithString(
            string: &Foundation::NSString,
        ) -> Id<Object, Shared>;
    }
);
