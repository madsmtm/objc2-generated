...
extern_protocol!(
    ...
    ///
    /// If your app enters the background with an active file presenter, any other processes that perform a coordinated read or write on the presented file can deadlock. To prevent this situation, call the coordinator's ``NSFileCoordinator/removeFilePresenter(_:)`` type method to remove the file presenter in the
    /// <doc
    ...
    /// <doc
    /// ://com.apple.documentation/documentation/uikit/uiapplication/didenterbackgroundnotification> notification. Call ``NSFileCoordinator/addFilePresenter(_:)`` to add the file presenter again in the
    /// <doc
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nsfilepresenter?language=objc)
