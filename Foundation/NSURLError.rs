...
extern_static!(NSURLErrorDomain: &'static Foundation::NSErrorDomain);

extern_static!(NSURLErrorFailingURLErrorKey: &'static Foundation::NSString);

extern_static!(NSURLErrorFailingURLStringErrorKey: &'static Foundation::NSString);

extern_static!(NSErrorFailingURLStringKey: &'static Foundation::NSString);

extern_static!(NSURLErrorFailingURLPeerTrustErrorKey: &'static Foundation::NSString);

extern_static!(NSURLErrorBackgroundTaskCancelledReasonKey: &'static Foundation::NSString);
...
extern_static!(NSURLErrorNetworkUnavailableReasonKey: &'static Foundation::NSErrorUserInfoKey);
