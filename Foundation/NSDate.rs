...
extern_static!(NSSystemClockDidChangeNotification: &'static Foundation::NSNotificationName);
...
extern_methods!(
    ...
    unsafe impl NSDate {
        ...
        pub unsafe fn distantFuture() -> Id<Foundation::NSDate, Shared>;

        #[method_id(@__retain_semantics Other distantPast)]
        pub unsafe fn distantPast() -> Id<Foundation::NSDate, Shared>;

        #[method_id(@__retain_semantics Other now)]
        pub unsafe fn now() -> Id<Foundation::NSDate, Shared>;
