...
extern_methods!(
    ...
    unsafe impl NSIndexPath {
        ...
        pub unsafe fn indexPathByAddingIndex(
            &self,
            index: NSUInteger,
        ) -> Id<Foundation::NSIndexPath, Shared>;

        #[method_id(@__retain_semantics Other indexPathByRemovingLastIndex)]
        pub unsafe fn indexPathByRemovingLastIndex(&self) -> Id<Foundation::NSIndexPath, Shared>;
        ...
        #[method(compare:)]
        pub unsafe fn compare(&self, otherObject: &Foundation::NSIndexPath) -> NSComparisonResult;
    }
);
