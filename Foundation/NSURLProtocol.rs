...
extern_methods!(
    unsafe impl NSURLProtocol {
        #[cfg(all(feature = "Foundation_NSURLCache", feature = "Foundation_NSURLRequest"))]
...
extern_methods!(
    ...
    unsafe impl NSURLProtocol {
        ...
        #[cfg(all(feature = "Foundation_NSURLCache", feature = "Foundation_NSURLSession"))]
