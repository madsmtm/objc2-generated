...
extern_methods!(
        ...
        NSMeasurement<UnitType, UnitTypeOwnership>
    {
        ...
        pub unsafe fn canBeConvertedToUnit(&self, unit: &Foundation::NSUnit) -> bool;
        ...
        ) -> Id<Foundation::NSMeasurement, Shared>;

        #[method_id(@__retain_semantics Other measurementByAddingMeasurement:)]
        pub unsafe fn measurementByAddingMeasurement(
            &self,
            measurement: &Foundation::NSMeasurement<UnitType>,
        ) -> Id<Foundation::NSMeasurement<UnitType>, Shared>;
