...
extern_methods!(
    ...
    unsafe impl NSXMLParser {
        ...
        pub unsafe fn allowedExternalEntityURLs(
            &self,
        ) -> Option<Id<Foundation::NSSet<Foundation::NSURL>, Shared>>;

        #[cfg(all(feature = "Foundation_NSSet", feature = "Foundation_NSURL"))]
        #[method(setAllowedExternalEntityURLs:)]
        pub unsafe fn setAllowedExternalEntityURLs(
            &self,
            allowedExternalEntityURLs: Option<&Foundation::NSSet<Foundation::NSURL>>,
        );
        ...
        pub unsafe fn parserError(&self) -> Option<Id<Foundation::NSError, Shared>>;
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSXMLParserDelegate {
        ...
        pub unsafe fn parserDidStartDocument(&self, parser: &Foundation::NSXMLParser);

        #[optional]
        #[method(parserDidEndDocument:)]
        pub unsafe fn parserDidEndDocument(&self, parser: &Foundation::NSXMLParser);
        ...
        pub unsafe fn parser_foundNotationDeclarationWithName_publicID_systemID(
            &self,
            parser: &Foundation::NSXMLParser,
            name: &Foundation::NSString,
            publicID: Option<&Foundation::NSString>,
            systemID: Option<&Foundation::NSString>,
        );
        ...
        pub unsafe fn parser_foundUnparsedEntityDeclarationWithName_publicID_systemID_notationName(
            ...
            publicID: Option<&Foundation::NSString>,
            systemID: Option<&Foundation::NSString>,
            notationName: Option<&Foundation::NSString>,
        );
        ...
        pub unsafe fn parser_foundAttributeDeclarationWithName_forElement_type_defaultValue(
            &self,
            parser: &Foundation::NSXMLParser,
            attributeName: &Foundation::NSString,
            elementName: &Foundation::NSString,
            type_: Option<&Foundation::NSString>,
            defaultValue: Option<&Foundation::NSString>,
        );
        ...
        pub unsafe fn parser_didStartElement_namespaceURI_qualifiedName_attributes(
            ...
            parser: &Foundation::NSXMLParser,
            elementName: &Foundation::NSString,
            namespaceURI: Option<&Foundation::NSString>,
            qName: Option<&Foundation::NSString>,
            attributeDict: &Foundation::NSDictionary<Foundation::NSString, Foundation::NSString>,
        );
        ...
        pub unsafe fn parser_didStartMappingPrefix_toURI(
            &self,
            parser: &Foundation::NSXMLParser,
            prefix: &Foundation::NSString,
            namespaceURI: &Foundation::NSString,
        );

        #[optional]
        #[method(parser:didEndMappingPrefix:)]
        pub unsafe fn parser_didEndMappingPrefix(
            &self,
            parser: &Foundation::NSXMLParser,
            prefix: &Foundation::NSString,
        );
        ...
        pub unsafe fn parser_foundCharacters(
            &self,
            parser: &Foundation::NSXMLParser,
        ...
        pub unsafe fn parser_foundIgnorableWhitespace(
            &self,
            parser: &Foundation::NSXMLParser,
            whitespaceString: &Foundation::NSString,
        );
        ...
        pub unsafe fn parser_foundProcessingInstructionWithTarget_data(
            ...
            data: Option<&Foundation::NSString>,
        );

        #[optional]
        #[method(parser:foundComment:)]
        pub unsafe fn parser_foundComment(
            &self,
            parser: &Foundation::NSXMLParser,
            comment: &Foundation::NSString,
        );

        #[optional]
        #[method(parser:foundCDATA:)]
        pub unsafe fn parser_foundCDATA(
            &self,
            parser: &Foundation::NSXMLParser,
            CDATABlock: &Foundation::NSData,
        );
        ...
        pub unsafe fn parser_parseErrorOccurred(
            &self,
            parser: &Foundation::NSXMLParser,
            parseError: &Foundation::NSError,
        );
        ...
        pub unsafe fn parser_validationErrorOccurred(
            &self,
            parser: &Foundation::NSXMLParser,
            validationError: &Foundation::NSError,
        );
    }
);

extern_static!(NSXMLParserErrorDomain: &'static Foundation::NSErrorDomain);
