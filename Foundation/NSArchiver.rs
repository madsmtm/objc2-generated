...
extern_methods!(
    ...
    unsafe impl NSArchiver {
        ...
        pub unsafe fn initForWritingWithMutableData(
            ...
            mdata: &Foundation::NSMutableData,
        ) -> Id<Self, Shared>;

        #[cfg(feature = "Foundation_NSMutableData")]
        #[method_id(@__retain_semantics Other archiverData)]
        pub unsafe fn archiverData(&self) -> Id<Foundation::NSMutableData, Owned>;
        ...
        pub unsafe fn encodeClassName_intoClassName(
            &self,
            trueName: &Foundation::NSString,
            inArchiveName: &Foundation::NSString,
        );
