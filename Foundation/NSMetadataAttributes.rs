...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSString`](https://developer.apple.com/documentation/foundation/nsstring) object with the name of the item as seen in the file system.
    ///
    ///
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSString`](https://developer.apple.com/documentation/foundation/nsstring) object with the display name of the item, which may be different then the file system name.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSURL`](https://developer.apple.com/documentation/foundation/nsurl) object that you can use to open the file.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSString`](https://developer.apple.com/documentation/foundation/nsstring) object that contains the full path to the file
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that indicates the size (in bytes) of the file on disk.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSDate`](https://developer.apple.com/documentation/foundation/nsdate) object that contains the date and time that the file was created.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSDate`](https://developer.apple.com/documentation/foundation/nsdate) object that contains the date and time that the file contents last changed.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains a Boolean indicating whether the item is stored in the cloud.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains a Boolean indicating whether the item is currently in conflict with another version of the file somewhere else.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains a Boolean indicating whether the current version of the item has been downloaded and is available locally.
    ///
    /// This constant is deprecated in iOS 7 and OS X v10.9; use [`NSMetadataUbiquitousItemDownloadingStatusKey`](https://developer.apple.com/documentation/foundation/nsmetadataubiquitousitemdownloadingstatuskey) instead.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// A string used as the value for [`NSMetadataUbiquitousItemPercentUploadedKey`](https://developer.apple.com/documentation/foundation/nsmetadataubiquitousitempercentuploadedkey) to indicate that this item has not been downloaded yet.
    ///
    /// You can use [`startDownloadingUbiquitousItemAtURL:error:`](https://developer.apple.com/documentation/foundation/filemanager/startdownloadingubiquitousitem(at:)) to download the item.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// A string used as the value for [`NSMetadataUbiquitousItemPercentUploadedKey`](https://developer.apple.com/documentation/foundation/nsmetadataubiquitousitempercentuploadedkey) to indicate that there is a local version of this item available.
    ///
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// A string used as the value for [`NSMetadataUbiquitousItemPercentUploadedKey`](https://developer.apple.com/documentation/foundation/nsmetadataubiquitousitempercentuploadedkey) to indicate that there is a local version of this item and it is the most up-to-date version known to this device.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains a Boolean indicating whether the item is currently being downloaded to the local device.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains a Boolean indicating whether the item has been uploaded to the cloud.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains a Boolean indicating whether the current version of the item is currently being uploaded to the cloud.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains the percentage of the file that has already been downloaded from the cloud. The value is a double in the range `0.0` to `100.0`.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSNumber`](https://developer.apple.com/documentation/foundation/nsnumber) object that contains the percentage of the file that has already been uploaded to the cloud. The value is a double in the range `0.0` to `100.0`.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSError`](https://developer.apple.com/documentation/foundation/nserror) object that describes the problem that occurred when downloading the item from iCloud failed.
    ///
    ///
    #[cfg(feature = "NSString")]
...
extern "C" {
    ...
    /// ## Discussion
    ///
    /// The value is an [`NSError`](https://developer.apple.com/documentation/foundation/nserror) object that describes the problem that occurred when uploading the item to iCloud failed.
    ///
    ///
    #[cfg(feature = "NSString")]
