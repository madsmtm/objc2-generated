...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nslengthformatterunit?language=objc)
// NS_ENUM
#[repr(transparent)]
...
extern_class!(
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/foundation/nslengthformatter?language=objc)
...
impl NSLengthFormatter {
    extern_methods!(
        ...
        #[unsafe(method_family = none)]
        pub fn unitStringFromMeters_usedUnit(
            &self,
            number_in_meters: c_double,
            unitp: Option<&mut NSLengthFormatterUnit>,
        ) -> Retained<NSString>;
