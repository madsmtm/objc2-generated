...
extern_methods!(
    ...
    unsafe impl NSFileHandle {
        ...
        pub unsafe fn availableData(&self) -> Id<Foundation::NSData, Shared>;
...
extern_methods!(
    ...
    unsafe impl NSFileHandle {
        ...
        pub unsafe fn fileHandleWithStandardInput() -> Id<Foundation::NSFileHandle, Shared>;

        #[method_id(@__retain_semantics Other fileHandleWithStandardOutput)]
        pub unsafe fn fileHandleWithStandardOutput() -> Id<Foundation::NSFileHandle, Shared>;

        #[method_id(@__retain_semantics Other fileHandleWithStandardError)]
        pub unsafe fn fileHandleWithStandardError() -> Id<Foundation::NSFileHandle, Shared>;

        #[method_id(@__retain_semantics Other fileHandleWithNullDevice)]
        pub unsafe fn fileHandleWithNullDevice() -> Id<Foundation::NSFileHandle, Shared>;

        #[cfg(feature = "Foundation_NSString")]
        #[method_id(@__retain_semantics Other fileHandleForReadingAtPath:)]
        pub unsafe fn fileHandleForReadingAtPath(
            path: &Foundation::NSString,
        ) -> Option<Id<Self, Shared>>;

        #[cfg(feature = "Foundation_NSString")]
        #[method_id(@__retain_semantics Other fileHandleForWritingAtPath:)]
        pub unsafe fn fileHandleForWritingAtPath(
            path: &Foundation::NSString,
        ) -> Option<Id<Self, Shared>>;
...
extern_static!(NSFileHandleOperationException: &'static Foundation::NSExceptionName);

extern_static!(NSFileHandleReadCompletionNotification: &'static Foundation::NSNotificationName);

extern_static!(
    NSFileHandleReadToEndOfFileCompletionNotification: &'static Foundation::NSNotificationName
);

extern_static!(NSFileHandleConnectionAcceptedNotification: &'static Foundation::NSNotificationName);

extern_static!(NSFileHandleDataAvailableNotification: &'static Foundation::NSNotificationName);

extern_static!(NSFileHandleNotificationDataItem: &'static Foundation::NSString);

extern_static!(NSFileHandleNotificationFileHandleItem: &'static Foundation::NSString);

extern_static!(NSFileHandleNotificationMonitorModes: &'static Foundation::NSString);
...
extern_methods!(
    ...
    unsafe impl NSFileHandle {
        ...
        pub unsafe fn readabilityHandler(
            &self,
        ) -> *mut Block<(NonNull<Foundation::NSFileHandle>,), ()>;

        #[method(setReadabilityHandler:)]
        pub unsafe fn setReadabilityHandler(
            &self,
            readabilityHandler: Option<&Block<(NonNull<Foundation::NSFileHandle>,), ()>>,
        );
        ...
        pub unsafe fn setWriteabilityHandler(
            &self,
            writeabilityHandler: Option<&Block<(NonNull<Foundation::NSFileHandle>,), ()>>,
        );
    }
);
...
extern_methods!(
    ...
    unsafe impl NSFileHandle {
        ...
        pub unsafe fn readDataToEndOfFile(&self) -> Id<Foundation::NSData, Shared>;

        #[cfg(feature = "Foundation_NSData")]
        #[method_id(@__retain_semantics Other readDataOfLength:)]
        pub unsafe fn readDataOfLength(&self, length: NSUInteger)
            -> Id<Foundation::NSData, Shared>;

        #[cfg(feature = "Foundation_NSData")]
        #[method(writeData:)]
        pub unsafe fn writeData(&self, data: &Foundation::NSData);
...
extern_methods!(
    ...
    unsafe impl NSPipe {
        ...
        pub unsafe fn fileHandleForReading(&self) -> Id<Foundation::NSFileHandle, Shared>;

        #[cfg(feature = "Foundation_NSFileHandle")]
        #[method_id(@__retain_semantics Other fileHandleForWriting)]
        pub unsafe fn fileHandleForWriting(&self) -> Id<Foundation::NSFileHandle, Shared>;

        #[method_id(@__retain_semantics Other pipe)]
        pub unsafe fn pipe() -> Id<Foundation::NSPipe, Shared>;
    }
);
