...
extern_methods!(
    ...
    unsafe impl NSValue {
        ...
        pub unsafe fn valueWithPointer(pointer: *mut c_void) -> Id<Foundation::NSValue, Shared>;

        #[method(pointerValue)]
        pub unsafe fn pointerValue(&self) -> *mut c_void;

        #[method(isEqualToValue:)]
        pub fn isEqualToValue(&self, value: &Foundation::NSValue) -> bool;
    }
);
...
extern_methods!(
    ...
    unsafe impl NSNumber {
        ...
        pub fn numberWithChar(value: c_char) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithUnsignedChar:)]
        pub fn numberWithUnsignedChar(value: c_uchar) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithShort:)]
        pub fn numberWithShort(value: c_short) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithUnsignedShort:)]
        pub fn numberWithUnsignedShort(value: c_ushort) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithInt:)]
        pub fn numberWithInt(value: c_int) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithUnsignedInt:)]
        pub fn numberWithUnsignedInt(value: c_uint) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithLong:)]
        pub fn numberWithLong(value: c_long) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithUnsignedLong:)]
        pub fn numberWithUnsignedLong(value: c_ulong) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithLongLong:)]
        pub fn numberWithLongLong(value: c_longlong) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithUnsignedLongLong:)]
        pub fn numberWithUnsignedLongLong(value: c_ulonglong) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithFloat:)]
        pub fn numberWithFloat(value: c_float) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithDouble:)]
        pub fn numberWithDouble(value: c_double) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithBool:)]
        pub fn numberWithBool(value: bool) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithInteger:)]
        pub fn numberWithInteger(value: NSInteger) -> Id<Foundation::NSNumber, Shared>;

        #[method_id(@__retain_semantics Other numberWithUnsignedInteger:)]
        pub fn numberWithUnsignedInteger(value: NSUInteger) -> Id<Foundation::NSNumber, Shared>;
    }
);
