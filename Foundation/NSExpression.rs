...
extern_methods!(
    ...
    unsafe impl NSExpression {
        ...
        pub unsafe fn expressionForFunction_selectorName_arguments(
            target: &Foundation::NSExpression,
            name: &Foundation::NSString,
            parameters: Option<&Foundation::NSArray>,
        ) -> Id<Foundation::NSExpression, Shared>;

        #[method_id(@__retain_semantics Other expressionForAnyKey)]
        pub unsafe fn expressionForAnyKey() -> Id<Foundation::NSExpression, Shared>;
        ...
        pub unsafe fn expressionForBlock_arguments(
            block: &Block<
                (
                    *mut Object,
                    NonNull<Foundation::NSArray<Foundation::NSExpression>>,
                    *mut Foundation::NSMutableDictionary,
                ),
                NonNull<Object>,
            >,
            arguments: Option<&Foundation::NSArray<Foundation::NSExpression>>,
        ) -> Id<Foundation::NSExpression, Shared>;
        ...
        pub unsafe fn expressionForConditional_trueExpression_falseExpression(
            predicate: &Foundation::NSPredicate,
            trueExpression: &Foundation::NSExpression,
            falseExpression: &Foundation::NSExpression,
        ) -> Id<Foundation::NSExpression, Shared>;
        ...
        pub unsafe fn keyPath(&self) -> Id<Foundation::NSString, Shared>;

        #[cfg(feature = "Foundation_NSString")]
        #[method_id(@__retain_semantics Other function)]
        pub unsafe fn function(&self) -> Id<Foundation::NSString, Shared>;

        #[cfg(feature = "Foundation_NSString")]
        #[method_id(@__retain_semantics Other variable)]
        pub unsafe fn variable(&self) -> Id<Foundation::NSString, Shared>;

        #[method_id(@__retain_semantics Other operand)]
        pub unsafe fn operand(&self) -> Id<Foundation::NSExpression, Shared>;
        ...
        pub unsafe fn predicate(&self) -> Id<Foundation::NSPredicate, Shared>;
        ...
        pub unsafe fn trueExpression(&self) -> Id<Foundation::NSExpression, Shared>;

        #[method_id(@__retain_semantics Other falseExpression)]
        pub unsafe fn falseExpression(&self) -> Id<Foundation::NSExpression, Shared>;
        ...
        pub unsafe fn expressionValueWithObject_context(
            ...
            context: Option<&Foundation::NSMutableDictionary>,
