...
extern_methods!(
        ...
        NSOrderedCollectionDifference<ObjectType, ObjectTypeOwnership>
    {
        ...
        pub unsafe fn initWithChanges(
            ...
            changes: &Foundation::NSArray<Foundation::NSOrderedCollectionChange<ObjectType>>,
        ) -> Id<Self, Shared>;
        ...
        pub unsafe fn initWithInsertIndexes_insertedObjects_removeIndexes_removedObjects_additionalChanges(
            this: Option<Allocated<Self>>,
            inserts: &Foundation::NSIndexSet,
            insertedObjects: Option<&Foundation::NSArray<ObjectType>>,
            removes: &Foundation::NSIndexSet,
            removedObjects: Option<&Foundation::NSArray<ObjectType>>,
            changes: &Foundation::NSArray<Foundation::NSOrderedCollectionChange<ObjectType>>,
        ) -> Id<Self, Shared>;
        ...
        pub unsafe fn insertions(
            &self,
        ) -> Id<Foundation::NSArray<Foundation::NSOrderedCollectionChange<ObjectType>>, Shared>;
        ...
        pub unsafe fn differenceByTransformingChangesWithBlock(
            &self,
            block: &Block<
                (NonNull<Foundation::NSOrderedCollectionChange<ObjectType>>,),
                NonNull<Foundation::NSOrderedCollectionChange<Object>>,
            >,
        ) -> Id<Foundation::NSOrderedCollectionDifference<Object>, Shared>;
