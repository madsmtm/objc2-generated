...
extern_fn!(
    pub unsafe fn NSGetUncaughtExceptionHandler() -> *mut Foundation::NSUncaughtExceptionHandler;
);

extern_fn!(
    pub unsafe fn NSSetUncaughtExceptionHandler(_: *mut Foundation::NSUncaughtExceptionHandler);
);
