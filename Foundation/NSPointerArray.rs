...
extern_methods!(
    ...
    unsafe impl NSPointerArray {
        ...
        pub unsafe fn strongObjectsPointerArray() -> Id<Foundation::NSPointerArray, Shared>;

        #[method_id(@__retain_semantics Other weakObjectsPointerArray)]
        pub unsafe fn weakObjectsPointerArray() -> Id<Foundation::NSPointerArray, Shared>;

        #[cfg(feature = "Foundation_NSArray")]
        #[method_id(@__retain_semantics Other allObjects)]
        pub unsafe fn allObjects(&self) -> Id<Foundation::NSArray, Shared>;
    }
);
