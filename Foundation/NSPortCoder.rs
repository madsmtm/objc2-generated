...
extern_methods!(
    ...
    unsafe impl NSPortCoder {
        ...
        pub unsafe fn encodePortObject(&self, aport: &Foundation::NSPort);

        #[cfg(feature = "Foundation_NSPort")]
        #[method_id(@__retain_semantics Other decodePortObject)]
        pub unsafe fn decodePortObject(&self) -> Option<Id<Foundation::NSPort, Shared>>;

        #[cfg(feature = "Foundation_NSConnection")]
        #[method_id(@__retain_semantics Other connection)]
        pub unsafe fn connection(&self) -> Option<Id<Foundation::NSConnection, Shared>>;
        ...
        pub unsafe fn portCoderWithReceivePort_sendPort_components(
            rcvPort: Option<&Foundation::NSPort>,
            sndPort: Option<&Foundation::NSPort>,
            comps: Option<&Foundation::NSArray>,
        ) -> Id<Object, Shared>;
