...
extern_class!(
    ...
    /// ## Overview
    ///
    /// You don’t typically use an instance of this class directly. Instead, use one of its subclasses to represent a particular activity metric. For example, use a [`CLSScoreItem`](https://developer.apple.com/documentation/classkit/clsscoreitem) to add a score to a [`CLSContextTypeQuiz`](https://developer.apple.com/documentation/classkit/clscontexttype/quiz) activity.
    ///
    ///
