...
impl CLSDataStore {
    extern_methods!(
        ...
        ///
        ///
        /// This method checks if the document at the specified URL is assigned to the current student
        ...
        ///
        ///
        /// Parameter `documentURL`: The file URL of the document to check.
        ///
        ///
        /// Parameter `completion`: A block called when the check is complete. The block takes two parameters:
