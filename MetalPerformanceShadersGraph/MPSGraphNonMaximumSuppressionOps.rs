...
impl MPSGraph {
    extern_methods!(
        ...
        #[unsafe(method(nonMaximumSuppressionWithBoxesTensor:scoresTensor:IOUThreshold:scoreThreshold:perClassSuppression:coordinateMode:name:))]
        ...
        /// - coordinateMode: The coordinate mode the box coordinates are provided in.
        /// - name: The name for the operation.
        #[unsafe(method(nonMaximumSuppressionWithBoxesTensor:scoresTensor:classIndicesTensor:IOUThreshold:scoreThreshold:perClassSuppression:coordinateMode:name:))]
        #[unsafe(method_family = none)]
