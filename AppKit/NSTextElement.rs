...
extern_methods!(
    ...
    unsafe impl NSTextElement {
        ...
        pub unsafe fn initWithTextContentManager(
            ...
            textContentManager: Option<&AppKit::NSTextContentManager>,
        ) -> Id<Self, Shared>;
        ...
        pub unsafe fn elementRange(&self) -> Option<Id<AppKit::NSTextRange, Shared>>;

        #[cfg(feature = "AppKit_NSTextRange")]
        #[method(setElementRange:)]
        pub unsafe fn setElementRange(&self, elementRange: Option<&AppKit::NSTextRange>);
    }
);
...
extern_methods!(
    ...
    unsafe impl NSTextParagraph {
        ...
        pub unsafe fn paragraphContentRange(&self) -> Option<Id<AppKit::NSTextRange, Shared>>;

        #[cfg(feature = "AppKit_NSTextRange")]
        #[method_id(@__retain_semantics Other paragraphSeparatorRange)]
        pub unsafe fn paragraphSeparatorRange(&self) -> Option<Id<AppKit::NSTextRange, Shared>>;
    }
);
