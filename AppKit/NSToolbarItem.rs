...
extern_methods!(
    ...
    unsafe impl NSToolbarItem {
        ...
        pub unsafe fn paletteLabel(&self) -> Id<Foundation::NSString, Shared>;

        #[cfg(feature = "Foundation_NSString")]
        #[method(setPaletteLabel:)]
        pub unsafe fn setPaletteLabel(&self, paletteLabel: &Foundation::NSString);
        ...
        pub unsafe fn menuFormRepresentation(&self) -> Option<Id<AppKit::NSMenuItem, Shared>>;

        #[cfg(feature = "AppKit_NSMenuItem")]
        #[method(setMenuFormRepresentation:)]
        pub unsafe fn setMenuFormRepresentation(
            &self,
            menuFormRepresentation: Option<&AppKit::NSMenuItem>,
        );
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSToolbarItemValidation {
        ...
        pub unsafe fn validateToolbarItem(&self, item: &AppKit::NSToolbarItem) -> bool;
    }
);

extern_static!(NSToolbarSeparatorItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarSpaceItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarFlexibleSpaceItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarShowColorsItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarShowFontsItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarCustomizeToolbarItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarPrintItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarToggleSidebarItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(NSToolbarCloudSharingItemIdentifier: &'static AppKit::NSToolbarItemIdentifier);

extern_static!(
    NSToolbarSidebarTrackingSeparatorItemIdentifier: &'static AppKit::NSToolbarItemIdentifier
);
