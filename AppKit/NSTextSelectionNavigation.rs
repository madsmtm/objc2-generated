...
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/direction?language=objc)
// NS_ENUM
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, Default)]
pub struct NSTextSelectionNavigationDirection(pub NSInteger);
impl NSTextSelectionNavigationDirection {
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/direction/forward?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDirectionForward")]
    pub const Forward: Self = Self(0);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/direction/backward?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDirectionBackward")]
    pub const Backward: Self = Self(1);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/direction/right?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDirectionRight")]
    pub const Right: Self = Self(2);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/direction/left?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDirectionLeft")]
    pub const Left: Self = Self(3);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/direction/up?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDirectionUp")]
    pub const Up: Self = Self(4);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/direction/down?language=objc)
...
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination?language=objc)
// NS_ENUM
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, Default)]
pub struct NSTextSelectionNavigationDestination(pub NSInteger);
impl NSTextSelectionNavigationDestination {
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination/character?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDestinationCharacter")]
    pub const Character: Self = Self(0);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination/word?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDestinationWord")]
    pub const Word: Self = Self(1);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination/line?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDestinationLine")]
    pub const Line: Self = Self(2);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination/sentence?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDestinationSentence")]
    pub const Sentence: Self = Self(3);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination/paragraph?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDestinationParagraph")]
    pub const Paragraph: Self = Self(4);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination/container?language=objc)
    #[doc(alias = "NSTextSelectionNavigationDestinationContainer")]
    pub const Container: Self = Self(5);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/destination/document?language=objc)
...
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/modifier?language=objc)
// NS_OPTIONS
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, Default)]
...
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/modifier/extend?language=objc)
        #[doc(alias = "NSTextSelectionNavigationModifierExtend")]
        const Extend = 1<<0;
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/modifier/visual?language=objc)
        #[doc(alias = "NSTextSelectionNavigationModifierVisual")]
        const Visual = 1<<1;
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/modifier/multiple?language=objc)
...
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/writingdirection?language=objc)
// NS_ENUM
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, Default)]
pub struct NSTextSelectionNavigationWritingDirection(pub NSInteger);
impl NSTextSelectionNavigationWritingDirection {
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/writingdirection/lefttoright?language=objc)
    #[doc(alias = "NSTextSelectionNavigationWritingDirectionLeftToRight")]
    pub const LeftToRight: Self = Self(0);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/writingdirection/righttoleft?language=objc)
...
/// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/layoutorientation?language=objc)
// NS_ENUM
#[repr(transparent)]
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, Default)]
pub struct NSTextSelectionNavigationLayoutOrientation(pub NSInteger);
impl NSTextSelectionNavigationLayoutOrientation {
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/layoutorientation/horizontal?language=objc)
    #[doc(alias = "NSTextSelectionNavigationLayoutOrientationHorizontal")]
    pub const Horizontal: Self = Self(0);
    /// [Apple's documentation](https://developer.apple.com/documentation/appkit/nstextselectionnavigation/layoutorientation/vertical?language=objc)
