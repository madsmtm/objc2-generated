...
extern_methods!(
    unsafe impl NSInputManager {
        #[deprecated]
        #[method_id(@__method_family Other currentInputManager)]
        ...
        #[deprecated]
        #[method_id(@__method_family Init initWithName:host:)]
        ...
        #[deprecated]
        #[method_id(@__method_family Other localizedInputManagerName)]
