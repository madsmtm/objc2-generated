...
extern_methods!(
    ...
    unsafe impl NSSpeechRecognizer {
        ...
        #[cfg(all(feature = "Foundation_NSArray", feature = "Foundation_NSString"))]
        #[method(setCommands:)]
        pub unsafe fn setCommands(
            &self,
            commands: Option<&Foundation::NSArray<Foundation::NSString>>,
        );

        #[cfg(feature = "Foundation_NSString")]
        #[method_id(@__retain_semantics Other displayedCommandsTitle)]
        pub unsafe fn displayedCommandsTitle(&self) -> Option<Id<Foundation::NSString, Shared>>;

        #[cfg(feature = "Foundation_NSString")]
        #[method(setDisplayedCommandsTitle:)]
        pub unsafe fn setDisplayedCommandsTitle(
            &self,
            displayedCommandsTitle: Option<&Foundation::NSString>,
        );
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSSpeechRecognizerDelegate {
        ...
        pub unsafe fn speechRecognizer_didRecognizeCommand(
            &self,
            sender: &AppKit::NSSpeechRecognizer,
            command: &Foundation::NSString,
        );
    }
);
