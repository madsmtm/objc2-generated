...
extern_methods!(
    ...
    unsafe impl NSVisualEffectView {
        ...
        pub unsafe fn maskImage(&self) -> Option<Id<AppKit::NSImage, Shared>>;

        #[cfg(feature = "AppKit_NSImage")]
        #[method(setMaskImage:)]
        pub unsafe fn setMaskImage(&self, maskImage: Option<&AppKit::NSImage>);
...
extern_methods!(
    ...
    #[cfg(feature = "AppKit_NSVisualEffectView")]
    unsafe impl AppKit::NSVisualEffectView {
