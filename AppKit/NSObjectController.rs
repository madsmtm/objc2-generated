...
extern_methods!(
    ...
    unsafe impl NSObjectController {
        ...
        pub unsafe fn setEntityName(&self, entityName: Option<&Foundation::NSString>);

        #[cfg(feature = "Foundation_NSPredicate")]
        #[method_id(@__retain_semantics Other fetchPredicate)]
        pub unsafe fn fetchPredicate(&self) -> Option<Id<Foundation::NSPredicate, Shared>>;

        #[cfg(feature = "Foundation_NSPredicate")]
        #[method(setFetchPredicate:)]
        pub unsafe fn setFetchPredicate(&self, fetchPredicate: Option<&Foundation::NSPredicate>);
        ...
        pub unsafe fn defaultFetchRequest(&self) -> Id<CoreData::NSFetchRequest, Shared>;
    }
);
