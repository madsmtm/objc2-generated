...
extern_methods!(
    ...
    unsafe impl NSRunningApplication {
        ...
        pub unsafe fn bundleURL(&self) -> Option<Id<Foundation::NSURL, Shared>>;
        ...
        pub unsafe fn launchDate(&self) -> Option<Id<Foundation::NSDate, Shared>>;
        ...
        ) -> Id<Foundation::NSArray<AppKit::NSRunningApplication>, Shared>;

        #[method_id(@__retain_semantics Other currentApplication)]
        pub unsafe fn currentApplication() -> Id<AppKit::NSRunningApplication, Shared>;
...
extern_methods!(
    ...
    unsafe impl AppKit::NSWorkspace {
        ...
        pub unsafe fn runningApplications(
            &self,
        ) -> Id<Foundation::NSArray<AppKit::NSRunningApplication>, Shared>;
    }
);
