...
pub type NSToolbarIdentifier = Foundation::NSString;

typed_extensible_enum!(
    pub type NSToolbarItemIdentifier = Foundation::NSString;
);
...
extern_methods!(
    ...
    unsafe impl NSToolbar {
        ...
        pub unsafe fn initWithIdentifier(
            ...
            identifier: &AppKit::NSToolbarIdentifier,
        ) -> Id<Self, Shared>;
        ...
        pub unsafe fn setSelectedItemIdentifier(
            &self,
            selectedItemIdentifier: Option<&AppKit::NSToolbarItemIdentifier>,
        );
        ...
        pub unsafe fn items(&self) -> Id<Foundation::NSArray<AppKit::NSToolbarItem>, Shared>;
        ...
        pub unsafe fn setCenteredItemIdentifier(
            &self,
            centeredItemIdentifier: Option<&AppKit::NSToolbarItemIdentifier>,
        );
        ...
        pub unsafe fn setConfigurationFromDictionary(
            &self,
            configDict: &Foundation::NSDictionary<Foundation::NSString, Object>,
        );

        #[cfg(all(feature = "Foundation_NSDictionary", feature = "Foundation_NSString"))]
        #[method_id(@__retain_semantics Other configurationDictionary)]
        pub unsafe fn configurationDictionary(
            &self,
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSToolbarDelegate {
        ...
        pub unsafe fn toolbarWillAddItem(&self, notification: &Foundation::NSNotification);

        #[optional]
        #[method(toolbarDidRemoveItem:)]
        pub unsafe fn toolbarDidRemoveItem(&self, notification: &Foundation::NSNotification);
    }
);

extern_static!(NSToolbarWillAddItemNotification: &'static Foundation::NSNotificationName);

extern_static!(NSToolbarDidRemoveItemNotification: &'static Foundation::NSNotificationName);
...
extern_methods!(
    ...
    unsafe impl NSToolbar {
        ...
        pub unsafe fn fullScreenAccessoryView(&self) -> Option<Id<AppKit::NSView, Shared>>;

        #[cfg(feature = "AppKit_NSView")]
        #[method(setFullScreenAccessoryView:)]
        pub unsafe fn setFullScreenAccessoryView(
            &self,
            fullScreenAccessoryView: Option<&AppKit::NSView>,
        );
