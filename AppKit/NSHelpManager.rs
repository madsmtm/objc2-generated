...
pub type NSHelpBookName = Foundation::NSString;

pub type NSHelpAnchorName = Foundation::NSString;

pub type NSHelpManagerContextHelpKey = Foundation::NSString;
...
extern_methods!(
    ...
    unsafe impl NSHelpManager {
        ...
        pub unsafe fn sharedHelpManager() -> Id<AppKit::NSHelpManager, Shared>;
        ...
        pub unsafe fn openHelpAnchor_inBook(
            &self,
            anchor: &AppKit::NSHelpAnchorName,
        ...
        pub unsafe fn findString_inBook(
            &self,
            query: &Foundation::NSString,
            book: Option<&AppKit::NSHelpBookName>,
        );

        #[cfg(feature = "Foundation_NSBundle")]
        #[method(registerBooksInBundle:)]
        pub unsafe fn registerBooksInBundle(&self, bundle: &Foundation::NSBundle) -> bool;
    }
);

extern_static!(NSContextHelpModeDidActivateNotification: &'static Foundation::NSNotificationName);

extern_static!(NSContextHelpModeDidDeactivateNotification: &'static Foundation::NSNotificationName);
...
extern_methods!(
    ...
    unsafe impl Foundation::NSBundle {
        ...
        pub unsafe fn contextHelpForKey(
            &self,
            key: &AppKit::NSHelpManagerContextHelpKey,
        ) -> Option<Id<Foundation::NSAttributedString, Shared>>;
    }
);
