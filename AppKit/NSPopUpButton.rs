...
extern_methods!(
    ...
    unsafe impl NSPopUpButton {
        ...
        #[cfg(feature = "Foundation_NSString")]
        #[method(setTitle:)]
        pub unsafe fn setTitle(&self, string: &Foundation::NSString);
...
extern_static!(NSPopUpButtonWillPopUpNotification: &'static Foundation::NSNotificationName);

extern_methods!(
    /// Methods declared on superclass `NSButton`
    #[cfg(feature = "AppKit_NSPopUpButton")]
    unsafe impl AppKit::NSPopUpButton {
