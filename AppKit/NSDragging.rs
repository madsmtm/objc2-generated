...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSDraggingInfo {
        ...
        pub unsafe fn draggingPasteboard(&self) -> Id<AppKit::NSPasteboard, Shared>;
        ...
        pub unsafe fn enumerateDraggingItemsWithOptions_forView_classes_searchOptions_usingBlock(
            ...
            block: &Block<(NonNull<AppKit::NSDraggingItem>, NSInteger, NonNull<Bool>), ()>,
        );
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSDraggingDestination {
        ...
        pub unsafe fn draggingExited(&self, sender: Option<&AppKit::NSDraggingInfo>);

        #[optional]
        #[method(prepareForDragOperation:)]
        pub unsafe fn prepareForDragOperation(&self, sender: &AppKit::NSDraggingInfo) -> bool;

        #[optional]
        #[method(performDragOperation:)]
        pub unsafe fn performDragOperation(&self, sender: &AppKit::NSDraggingInfo) -> bool;

        #[optional]
        #[method(concludeDragOperation:)]
        pub unsafe fn concludeDragOperation(&self, sender: Option<&AppKit::NSDraggingInfo>);

        #[optional]
        #[method(draggingEnded:)]
        pub unsafe fn draggingEnded(&self, sender: &AppKit::NSDraggingInfo);
        ...
        pub unsafe fn updateDraggingItemsForDrag(&self, sender: Option<&AppKit::NSDraggingInfo>);
    }
);
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSSpringLoadingDestination {
        ...
        pub unsafe fn springLoadingHighlightChanged(&self, draggingInfo: &AppKit::NSDraggingInfo);
        ...
        pub unsafe fn springLoadingExited(&self, draggingInfo: &AppKit::NSDraggingInfo);

        #[optional]
        #[method(draggingEnded:)]
        pub unsafe fn draggingEnded(&self, draggingInfo: &AppKit::NSDraggingInfo);
    }
);
