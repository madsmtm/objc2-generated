...
extern_methods!(
    ...
    unsafe impl NSWindowTabGroup {
        ...
        pub unsafe fn selectedWindow(&self) -> Option<Id<AppKit::NSWindow, Shared>>;

        #[cfg(feature = "AppKit_NSWindow")]
        #[method(setSelectedWindow:)]
        pub unsafe fn setSelectedWindow(&self, selectedWindow: Option<&AppKit::NSWindow>);

        #[cfg(feature = "AppKit_NSWindow")]
        #[method(addWindow:)]
        pub unsafe fn addWindow(&self, window: &AppKit::NSWindow);

        #[cfg(feature = "AppKit_NSWindow")]
        #[method(insertWindow:atIndex:)]
        pub unsafe fn insertWindow_atIndex(&self, window: &AppKit::NSWindow, index: NSInteger);

        #[cfg(feature = "AppKit_NSWindow")]
        #[method(removeWindow:)]
        pub unsafe fn removeWindow(&self, window: &AppKit::NSWindow);
    }
);
