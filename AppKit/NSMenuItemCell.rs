...
extern_class!(
    ...
    unsafe impl ClassType for NSMenuItemCell {
        ...
        type Super = AppKit::NSButtonCell;
    }
);
...
extern_methods!(
    ...
    unsafe impl NSMenuItemCell {
        ...
        pub unsafe fn menuItem(&self) -> Option<Id<AppKit::NSMenuItem, Shared>>;

        #[cfg(feature = "AppKit_NSMenuItem")]
        #[method(setMenuItem:)]
        pub unsafe fn setMenuItem(&self, menuItem: Option<&AppKit::NSMenuItem>);
...
extern_methods!(
    ...
    #[cfg(feature = "AppKit_NSMenuItemCell")]
    unsafe impl AppKit::NSMenuItemCell {
