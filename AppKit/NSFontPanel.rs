...
extern_protocol!(
    ...
    unsafe impl ProtocolType for NSFontChanging {
        #[optional]
        #[method(changeFont:)]
        pub unsafe fn changeFont(&self, sender: Option<&AppKit::NSFontManager>);
...
extern_methods!(
    ...
    unsafe impl NSFontPanel {
        ...
        pub unsafe fn sharedFontPanel() -> Id<AppKit::NSFontPanel, Shared>;
        ...
        pub unsafe fn setPanelFont_isMultiple(&self, fontObj: &AppKit::NSFont, flag: bool);

        #[cfg(feature = "AppKit_NSFont")]
        #[method_id(@__retain_semantics Other panelConvertFont:)]
        pub unsafe fn panelConvertFont(
            &self,
...
extern_methods!(
    ...
    #[cfg(feature = "AppKit_NSFontPanel")]
    unsafe impl AppKit::NSFontPanel {
