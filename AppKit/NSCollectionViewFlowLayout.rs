...
extern_static!(
    NSCollectionElementKindSectionHeader: &'static AppKit::NSCollectionViewSupplementaryElementKind
);

extern_static!(
    NSCollectionElementKindSectionFooter: &'static AppKit::NSCollectionViewSupplementaryElementKind
);
...
extern_class!(
    ...
    unsafe impl ClassType for NSCollectionViewFlowLayoutInvalidationContext {
        #[inherits(NSObject)]
        type Super = AppKit::NSCollectionViewLayoutInvalidationContext;
    }
);
