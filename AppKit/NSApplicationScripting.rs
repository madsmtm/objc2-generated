...
extern_methods!(
    ...
    unsafe impl AppKit::NSApplication {
        ...
        pub unsafe fn orderedDocuments(
            &self,
        ) -> Id<Foundation::NSArray<AppKit::NSDocument>, Shared>;

        #[cfg(all(feature = "AppKit_NSWindow", feature = "Foundation_NSArray"))]
        #[method_id(@__retain_semantics Other orderedWindows)]
        pub unsafe fn orderedWindows(&self) -> Id<Foundation::NSArray<AppKit::NSWindow>, Shared>;
    }
);
