...
extern_class!(
    ...
    /// ## Overview
    ///
    /// [`NSTextStorage`](https://developer.apple.com/documentation/appkit/nstextstorage) is a semi-concrete subclass of [`NSMutableAttributedString`](https://developer.apple.com/documentation/foundation/nsmutableattributedstring) that adds behavior for managing a set of client [`NSLayoutManager`](https://developer.apple.com/documentation/appkit/nslayoutmanager) objects. A text storage object notifies its layout managers of changes to its characters or attributes, which lets the layout managers redisplay the text as needed.
    ///
    ...
    ///
    /// These primitives should perform the change, then call [`edited:range:changeInLength:`](https://developer.apple.com/documentation/appkit/nstextstorage/edited(_:range:changeinlength:)) to let the parent class know there are changes.
    ///
    ///
