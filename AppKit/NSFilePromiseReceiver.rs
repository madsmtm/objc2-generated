...
extern_methods!(
    ...
    unsafe impl NSFilePromiseReceiver {
        ...
        pub unsafe fn readableDraggedTypes() -> Id<Foundation::NSArray<Foundation::NSString>, Shared>;

        #[cfg(all(feature = "Foundation_NSArray", feature = "Foundation_NSString"))]
        #[method_id(@__retain_semantics Other fileTypes)]
        pub unsafe fn fileTypes(&self) -> Id<Foundation::NSArray<Foundation::NSString>, Shared>;

        #[cfg(all(feature = "Foundation_NSArray", feature = "Foundation_NSString"))]
        #[method_id(@__retain_semantics Other fileNames)]
        pub unsafe fn fileNames(&self) -> Id<Foundation::NSArray<Foundation::NSString>, Shared>;
        ...
        pub unsafe fn receivePromisedFilesAtDestination_options_operationQueue_reader(
            &self,
            destinationDir: &Foundation::NSURL,
            options: &Foundation::NSDictionary,
            operationQueue: &Foundation::NSOperationQueue,
            reader: &Block<(NonNull<Foundation::NSURL>, *mut Foundation::NSError), ()>,
        );
    }
);
