...
extern_methods!(
    ...
    unsafe impl MLCActivationDescriptor {
        ...
        pub unsafe fn descriptorWithType_a(activation_type: MLCActivationType,a: c_float,) -> Option<Id<Self>>;

        #[method_id(@__retain_semantics Other descriptorWithType:a:b:)]
        pub unsafe fn descriptorWithType_a_b(activation_type: MLCActivationType,a: c_float,b: c_float,) -> Option<Id<Self>>;

        #[method_id(@__retain_semantics Other descriptorWithType:a:b:c:)]
        pub unsafe fn descriptorWithType_a_b_c(activation_type: MLCActivationType,a: c_float,b: c_float,c: c_float,) -> Option<Id<Self>>;
