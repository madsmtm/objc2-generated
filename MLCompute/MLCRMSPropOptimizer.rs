...
extern_methods!(
    ...
    unsafe impl MLCRMSPropOptimizer {
        ...
        pub unsafe fn optimizerWithDescriptor_momentumScale_alpha_epsilon_isCentered(optimizer_descriptor: &MLCOptimizerDescriptor,momentum_scale: c_float,alpha: c_float,epsilon: c_float,is_centered: bool,) -> Id<Self>;
