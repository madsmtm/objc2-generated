...
extern_methods!(
    ...
    unsafe impl MLCTensorParameter {
        ...
        #[cfg(all(feature = "Foundation_NSArray",feature = "MLCompute_MLCTensor",feature = "MLCompute_MLCTensorData"))]
        #[method_id(@__retain_semantics Other parameterWithTensor:optimizerData:)]
        pub unsafe fn parameterWithTensor_optimizerData(tensor: &MLCTensor,optimizer_data: Option<&NSArray<MLCTensorData,>>,) -> Id<Self>;
