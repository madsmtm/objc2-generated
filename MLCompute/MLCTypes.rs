...
extern_fn!(
    ...
    pub unsafe fn MLCActivationTypeDebugDescription(activation_type: MLCActivationType,) -> NonNull<NSString>;
);

extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCArithmeticOperationDebugDescription(operation: MLCArithmeticOperation,) -> NonNull<NSString>;
);

extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCPaddingPolicyDebugDescription(padding_policy: MLCPaddingPolicy,) -> NonNull<NSString>;
);
...
extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCReductionTypeDebugDescription(reduction_type: MLCReductionType,) -> NonNull<NSString>;
);

extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCPaddingTypeDebugDescription(padding_type: MLCPaddingType,) -> NonNull<NSString>;
);

extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCConvolutionTypeDebugDescription(convolution_type: MLCConvolutionType,) -> NonNull<NSString>;
);

extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCPoolingTypeDebugDescription(pooling_type: MLCPoolingType,) -> NonNull<NSString>;
);

extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCSoftmaxOperationDebugDescription(operation: MLCSoftmaxOperation,) -> NonNull<NSString>;
);
...
extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCComparisonOperationDebugDescription(operation: MLCComparisonOperation,) -> NonNull<NSString>;
);

extern_fn!(
    #[cfg(feature = "Foundation_NSString")]
    pub unsafe fn MLCGradientClippingTypeDebugDescription(gradient_clipping_type: MLCGradientClippingType,) -> NonNull<NSString>;
);
