...
extern_methods!(
    ...
    unsafe impl MLCInstanceNormalizationLayer {
        ...
        pub unsafe fn layerWithFeatureChannelCount_beta_gamma_varianceEpsilon(feature_channel_count: NSUInteger,beta: Option<&MLCTensor>,gamma: Option<&MLCTensor>,variance_epsilon: c_float,) -> Option<Id<Self>>;

        #[cfg(feature = "MLCompute_MLCTensor")]
        #[method_id(@__retain_semantics Other layerWithFeatureChannelCount:beta:gamma:varianceEpsilon:momentum:)]
        pub unsafe fn layerWithFeatureChannelCount_beta_gamma_varianceEpsilon_momentum(feature_channel_count: NSUInteger,beta: Option<&MLCTensor>,gamma: Option<&MLCTensor>,variance_epsilon: c_float,momentum: c_float,) -> Option<Id<Self>>;

        #[cfg(feature = "MLCompute_MLCTensor")]
        #[method_id(@__retain_semantics Other layerWithFeatureChannelCount:mean:variance:beta:gamma:varianceEpsilon:momentum:)]
        pub unsafe fn layerWithFeatureChannelCount_mean_variance_beta_gamma_varianceEpsilon_momentum(feature_channel_count: NSUInteger,mean: &MLCTensor,variance: &MLCTensor,beta: Option<&MLCTensor>,gamma: Option<&MLCTensor>,variance_epsilon: c_float,momentum: c_float,) -> Option<Id<Self>>;
