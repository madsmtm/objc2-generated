...
extern_methods!(
    ...
    unsafe impl MLCSGDOptimizer {
        ...
        pub unsafe fn optimizerWithDescriptor_momentumScale_usesNesterovMomentum(optimizer_descriptor: &MLCOptimizerDescriptor,momentum_scale: c_float,uses_nesterov_momentum: bool,) -> Id<Self>;
