...
extern_methods!(
    ...
    unsafe impl HKLiveWorkoutBuilder {
        ...
        #[method_id(@__method_family Init initWithHealthStore:configuration:device:)]
        ...
        #[method_id(@__method_family Other workoutSession)]
        ...
        #[method_id(@__method_family Other currentWorkoutActivity)]
