...
extern_methods!(
    unsafe impl HKAudiogramSensitivityPointClampingRange {
        ...
        #[method_id(@__method_family Other clampingRangeWithLowerBound:upperBound:error:_)]
