...
extern_methods!(
    unsafe impl UIBandSelectionInteraction {
        ...
        pub unsafe fn shouldBeginHandler(
            &self,
        ) -> *mut Block<dyn Fn(NonNull<UIBandSelectionInteraction>, CGPoint) -> Bool>;
        ...
        pub unsafe fn setShouldBeginHandler(
            ...
            should_begin_handler: Option<
                &Block<dyn Fn(NonNull<UIBandSelectionInteraction>, CGPoint) -> Bool>,
            >,
        );
        ...
        pub unsafe fn initWithSelectionHandler(
            this: Allocated<Self>,
            selection_handler: &Block<dyn Fn(NonNull<UIBandSelectionInteraction>)>,
        ) -> Id<Self>;
