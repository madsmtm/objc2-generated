...
#[cfg(feature = "block2")]
pub type UITraitMutations = *mut Block<dyn Fn(NonNull<ProtocolObject<dyn UIMutableTraits>>)>;
...
#[cfg(feature = "block2")]
pub type UITraitChangeHandler =
    *mut Block<dyn Fn(NonNull<ProtocolObject<dyn UITraitEnvironment>>, NonNull<UITraitCollection>)>;
