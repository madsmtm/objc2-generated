...
extern_protocol!(
    pub unsafe trait UISearchSuggestion: NSObjectProtocol + IsMainThreadOnly {
        ...
        unsafe fn localizedSuggestion(&self) -> Option<Id<NSString>>;

        #[optional]
        #[method_id(@__retain_semantics Other localizedDescription)]
        unsafe fn localizedDescription(&self) -> Option<Id<NSString>>;

        #[cfg(feature = "UIImage")]
        #[optional]
        #[method_id(@__retain_semantics Other iconImage)]
        unsafe fn iconImage(&self) -> Option<Id<UIImage>>;

        #[method_id(@__retain_semantics Other localizedAttributedSuggestion)]
        unsafe fn localizedAttributedSuggestion(&self) -> Option<Id<NSAttributedString>>;

        #[method_id(@__retain_semantics Other representedObject)]
        unsafe fn representedObject(&self) -> Option<Id<AnyObject>>;
...
extern_methods!(
    unsafe impl UISearchSuggestionItem {
        ...
        #[method_id(@__retain_semantics Other localizedAttributedSuggestion)]
        pub unsafe fn localizedAttributedSuggestion(&self) -> Option<Id<NSAttributedString>>;

        #[method_id(@__retain_semantics Other localizedSuggestion)]
        pub unsafe fn localizedSuggestion(&self) -> Option<Id<NSString>>;
        ...
        #[cfg(feature = "UIImage")]
        #[method_id(@__retain_semantics Other iconImage)]
        pub unsafe fn iconImage(&self) -> Option<Id<UIImage>>;
