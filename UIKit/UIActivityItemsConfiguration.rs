...
extern_methods!(
    unsafe impl UIActivityItemsConfiguration {
        ...
        pub unsafe fn metadataProvider(
            &self,
        ) -> *mut Block<dyn Fn(NonNull<UIActivityItemsConfigurationMetadataKey>) -> *mut AnyObject>;
        ...
        pub unsafe fn setMetadataProvider(
            ...
            metadata_provider: Option<
                &Block<dyn Fn(NonNull<UIActivityItemsConfigurationMetadataKey>) -> *mut AnyObject>,
            >,
        );
        ...
        pub unsafe fn applicationActivitiesProvider(
            &self,
        ) -> *mut Block<dyn Fn() -> NonNull<NSArray<UIActivity>>>;
        ...
        pub unsafe fn setApplicationActivitiesProvider(
            ...
            application_activities_provider: Option<
                &Block<dyn Fn() -> NonNull<NSArray<UIActivity>>>,
            >,
        );
