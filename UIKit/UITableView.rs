...
extern_methods!(
    unsafe impl UITableViewRowAction {
        ...
        pub unsafe fn rowActionWithStyle_title_handler(
            ...
            handler: &Block<dyn Fn(NonNull<UITableViewRowAction>, NonNull<NSIndexPath>)>,
...
extern_methods!(
    unsafe impl UITableViewPlaceholder {
        ...
        pub unsafe fn cellUpdateHandler(&self) -> *mut Block<dyn Fn(NonNull<UITableViewCell>)>;
        ...
        pub unsafe fn setCellUpdateHandler(
            &self,
            cell_update_handler: Option<&Block<dyn Fn(NonNull<UITableViewCell>)>>,
        );
    }
);
...
extern_methods!(
    unsafe impl UITableViewDropPlaceholder {
        ...
        pub unsafe fn previewParametersProvider(
            &self,
        ) -> *mut Block<dyn Fn(NonNull<UITableViewCell>) -> *mut UIDragPreviewParameters>;
        ...
        pub unsafe fn setPreviewParametersProvider(
            ...
            preview_parameters_provider: Option<
                &Block<dyn Fn(NonNull<UITableViewCell>) -> *mut UIDragPreviewParameters>,
            >,
        );
    }
);
