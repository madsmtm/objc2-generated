...
extern_methods!(
    unsafe impl<ItemIdentifierType: Message> NSDiffableDataSourceSectionSnapshot<ItemIdentifierType> {
        ...
        #[method_id(@__method_family Other insertSnapshot:afterItem:)]
        ...
        #[method_id(@__method_family Other rootItems)]
