...
extern_methods!(
    unsafe impl UIViewPropertyAnimator {
        ...
        pub unsafe fn initWithDuration_curve_animations(
            ...
            animations: Option<&Block<dyn Fn()>>,
        ) -> Id<Self>;
        ...
        pub unsafe fn runningPropertyAnimatorWithDuration_delay_options_animations_completion(
            ...
            completion: Option<&Block<dyn Fn(UIViewAnimatingPosition)>>,
        ...
        pub unsafe fn addAnimations(&self, animation: &Block<dyn Fn()>);

        #[cfg(all(feature = "UIViewAnimating", feature = "block2"))]
        #[method(addCompletion:)]
        pub unsafe fn addCompletion(&self, completion: &Block<dyn Fn(UIViewAnimatingPosition)>);
