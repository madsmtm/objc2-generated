...
/// ## Overview
///
/// Select a marker symbol to apply to your list elements in your text list, then set it in [`markerFormat`](https://developer.apple.com/documentation/uikit/nstextlist/markerformat-swift.property). Or, specify a marker symbol when you create a text list with [`initWithMarkerFormat:options:`](https://developer.apple.com/documentation/uikit/nstextlist/init(markerformat:options:)) or [`initWithMarkerFormat:options:startingItemNumber:`](https://developer.apple.com/documentation/uikit/nstextlist/init(markerformat:options:startingitemnumber:)).
///
///
...
extern_class!(
    ...
    ///
    /// Text lists appear as attributes on paragraphs, as part of the paragraph style. An [`NSParagraphStyle`](https://developer.apple.com/documentation/uikit/nsparagraphstyle) may have an array of text lists, representing the nested lists containing the paragraph, in order from outermost to innermost. For example, if list1 contains four paragraphs, the middle two of which are also in the inner list2, then the text lists array for the first and fourth paragraphs is (list1), while the text lists array for the second and third paragraphs is (list1, list2).
    ///
    /// The methods implementing this are [`textLists`](https://developer.apple.com/documentation/uikit/nsparagraphstyle/textlists) on [`NSParagraphStyle`](https://developer.apple.com/documentation/uikit/nsparagraphstyle), and [`textLists`](https://developer.apple.com/documentation/uikit/nsmutableparagraphstyle/textlists) on [`NSMutableParagraphStyle`](https://developer.apple.com/documentation/uikit/nsmutableparagraphstyle).
    ///
