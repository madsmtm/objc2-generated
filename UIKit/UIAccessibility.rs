...
#[cfg(feature = "block2")]
pub type AXBoolReturnBlock = *mut Block<dyn Fn() -> Bool>;

#[cfg(feature = "block2")]
pub type AXStringReturnBlock = *mut Block<dyn Fn() -> *mut NSString>;

#[cfg(feature = "block2")]
pub type AXStringArrayReturnBlock = *mut Block<dyn Fn() -> *mut NSArray<NSString>>;

#[cfg(feature = "block2")]
pub type AXAttributedStringReturnBlock = *mut Block<dyn Fn() -> *mut NSAttributedString>;

#[cfg(feature = "block2")]
pub type AXAttributedStringArrayReturnBlock =
    *mut Block<dyn Fn() -> *mut NSArray<NSAttributedString>>;

#[cfg(feature = "block2")]
pub type AXRectReturnBlock = *mut Block<dyn Fn() -> CGRect>;

#[cfg(all(feature = "UIBezierPath", feature = "block2"))]
pub type AXPathReturnBlock = *mut Block<dyn Fn() -> *mut UIBezierPath>;

#[cfg(feature = "block2")]
pub type AXPointReturnBlock = *mut Block<dyn Fn() -> CGPoint>;

#[cfg(feature = "block2")]
pub type AXObjectReturnBlock = *mut Block<dyn Fn() -> *mut AnyObject>;

#[cfg(feature = "block2")]
pub type AXArrayReturnBlock = *mut Block<dyn Fn() -> *mut NSArray>;

#[cfg(feature = "block2")]
pub type AXVoidReturnBlock = *mut Block<dyn Fn()>;

#[cfg(all(feature = "UIAccessibilityConstants", feature = "block2"))]
pub type AXTraitsReturnBlock = *mut Block<dyn Fn() -> UIAccessibilityTraits>;

#[cfg(all(feature = "UIAccessibilityConstants", feature = "block2"))]
pub type AXNavigationStyleReturnBlock = *mut Block<dyn Fn() -> UIAccessibilityNavigationStyle>;

#[cfg(all(feature = "UIAccessibilityConstants", feature = "block2"))]
pub type AXContainerTypeReturnBlock = *mut Block<dyn Fn() -> UIAccessibilityContainerType>;

#[cfg(all(feature = "UIAccessibilityConstants", feature = "block2"))]
pub type AXTextualContextReturnBlock = *mut Block<dyn Fn() -> *mut UIAccessibilityTextualContext>;

#[cfg(all(feature = "UIAccessibilityCustomAction", feature = "block2"))]
pub type AXCustomActionsReturnBlock =
    *mut Block<dyn Fn() -> *mut NSArray<UIAccessibilityCustomAction>>;
