...
extern_class!(
    ...
    /// ## Overview
    ///
    /// An `NSTextRange` consists of the starting and terminating locations. There the two basic properties: [`location`](https://developer.apple.com/documentation/uikit/nstextrange/location) and [`endLocation`](https://developer.apple.com/documentation/uikit/nstextrange/endlocation), respectively. The terminating [`location`](https://developer.apple.com/documentation/uikit/nstextrange/location), [`endLocation`](https://developer.apple.com/documentation/uikit/nstextrange/endlocation), is directly following the last location in the range. For example, a location contains a range if `(range.location <= location) && (location < range.endLocation)` is `true`.
    ///
    ///
    /// A class that represents a contiguous range between two locations inside document contents.
    ///
