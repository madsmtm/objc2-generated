...
extern_methods!(
        ...
        NSDiffableDataSourceSnapshot<SectionIdentifierType, ItemIdentifierType>
    {
        ...
        pub unsafe fn reloadedSectionIdentifiers(&self) -> Id<NSArray<SectionIdentifierType>>;

        #[method_id(@__retain_semantics Other reloadedItemIdentifiers)]
        pub unsafe fn reloadedItemIdentifiers(&self) -> Id<NSArray<ItemIdentifierType>>;

        #[method_id(@__retain_semantics Other reconfiguredItemIdentifiers)]
        pub unsafe fn reconfiguredItemIdentifiers(&self) -> Id<NSArray<ItemIdentifierType>>;
...
pub type UICollectionViewDiffableDataSourceCellProvider = *mut Block<
    dyn Fn(
...
pub type UICollectionViewDiffableDataSourceSupplementaryViewProvider = *mut Block<
    dyn Fn(
        NonNull<UICollectionView>,
        NonNull<NSString>,
        NonNull<NSIndexPath>,
...
extern_methods!(
        ...
        NSDiffableDataSourceSectionTransaction<SectionIdentifierType, ItemIdentifierType>
    {
        ...
        pub unsafe fn sectionIdentifier(&self) -> Id<SectionIdentifierType>;
        ...
        pub unsafe fn difference(&self) -> Id<NSOrderedCollectionDifference<ItemIdentifierType>>;
    }
);
...
extern_methods!(
        ...
        UICollectionViewDiffableDataSourceReorderingHandlers<SectionType, ItemType>
    {
        ...
        pub unsafe fn canReorderItemHandler(&self)
            -> *mut Block<dyn Fn(NonNull<ItemType>) -> Bool>;

        #[cfg(feature = "block2")]
        #[method(setCanReorderItemHandler:)]
        pub unsafe fn setCanReorderItemHandler(
            &self,
            can_reorder_item_handler: Option<&Block<dyn Fn(NonNull<ItemType>) -> Bool>>,
        );
        ...
        pub unsafe fn willReorderHandler(
            &self,
        ) -> *mut Block<dyn Fn(NonNull<NSDiffableDataSourceTransaction<SectionType, ItemType>>)>;
        ...
        pub unsafe fn setWillReorderHandler(
            ...
            will_reorder_handler: Option<
                &Block<dyn Fn(NonNull<NSDiffableDataSourceTransaction<SectionType, ItemType>>)>,
            >,
        );
...
extern_methods!(
    unsafe impl<ItemType: Message> UICollectionViewDiffableDataSourceSectionSnapshotHandlers<ItemType> {
        ...
        pub unsafe fn setShouldExpandItemHandler(
            &self,
            should_expand_item_handler: Option<&Block<dyn Fn(NonNull<ItemType>) -> Bool>>,
        );

        #[cfg(feature = "block2")]
        #[method(willExpandItemHandler)]
        pub unsafe fn willExpandItemHandler(&self) -> *mut Block<dyn Fn(NonNull<ItemType>)>;

        #[cfg(feature = "block2")]
        #[method(setWillExpandItemHandler:)]
        pub unsafe fn setWillExpandItemHandler(
            &self,
            will_expand_item_handler: Option<&Block<dyn Fn(NonNull<ItemType>)>>,
        );
        ...
        pub unsafe fn setShouldCollapseItemHandler(
            &self,
            should_collapse_item_handler: Option<&Block<dyn Fn(NonNull<ItemType>) -> Bool>>,
        );

        #[cfg(feature = "block2")]
        #[method(willCollapseItemHandler)]
        pub unsafe fn willCollapseItemHandler(&self) -> *mut Block<dyn Fn(NonNull<ItemType>)>;

        #[cfg(feature = "block2")]
        #[method(setWillCollapseItemHandler:)]
        pub unsafe fn setWillCollapseItemHandler(
            &self,
            will_collapse_item_handler: Option<&Block<dyn Fn(NonNull<ItemType>)>>,
        );
...
extern_methods!(
        ...
        UICollectionViewDiffableDataSource<SectionIdentifierType, ItemIdentifierType>
    {
        ...
        pub unsafe fn sectionSnapshotHandlers(
            &self,
        ) -> Id<UICollectionViewDiffableDataSourceSectionSnapshotHandlers<ItemIdentifierType>>;
...
pub type UITableViewDiffableDataSourceCellProvider = *mut Block<
