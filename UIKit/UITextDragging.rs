...
extern_protocol!(
    ...
    pub unsafe trait UITextDragDelegate: NSObjectProtocol + MainThreadOnly {
        ...
        #[optional]
        #[method(textDraggableView:itemsForDrag:)]
        #[unsafe(method_family = none)]
        ...
        #[optional]
        #[method(textDraggableView:dragPreviewForLiftingItem:session:)]
        #[unsafe(method_family = none)]
