...
extern_methods!(
    unsafe impl UICellAccessoryDetail {
        ...
        pub unsafe fn actionHandler(&self) -> *mut Block<dyn Fn()>;

        #[cfg(feature = "block2")]
        #[method(setActionHandler:)]
        pub unsafe fn setActionHandler(&self, action_handler: Option<&Block<dyn Fn()>>);
    }
);
...
extern_methods!(
    unsafe impl UICellAccessoryPopUpMenu {
        ...
        pub unsafe fn selectedElementDidChangeHandler(&self)
            -> *mut Block<dyn Fn(NonNull<UIMenu>)>;

        #[cfg(all(feature = "UIMenu", feature = "UIMenuElement", feature = "block2"))]
        #[method(setSelectedElementDidChangeHandler:)]
        pub unsafe fn setSelectedElementDidChangeHandler(
            &self,
            selected_element_did_change_handler: Option<&Block<dyn Fn(NonNull<UIMenu>)>>,
        );
...
pub type UICellAccessoryPosition =
    *mut Block<dyn Fn(NonNull<NSArray<UICellAccessory>>) -> NSUInteger>;
