...
extern_methods!(
    unsafe impl UINib {
        #[deprecated = "Loading Interface Builder products will not be supported in a future version of visionOS."]
        #[method_id(@__method_family Other nibWithNibName:bundle:)]
        ...
        #[deprecated = "Loading Interface Builder products will not be supported in a future version of visionOS."]
        #[method_id(@__method_family Other nibWithData:bundle:)]
        ...
        #[deprecated = "Loading Interface Builder products will not be supported in a future version of visionOS."]
        #[method_id(@__method_family Other instantiateWithOwner:options:)]
