...
impl FSExtentType {
    ...
    #[doc(alias = "FSExtentTypeReadOnly")]
...
extern_protocol!(
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/fskit/fsvolumekerneloffloadediohandler?language=objc)
    pub unsafe trait FSVolumeKernelOffloadedIOHandler: NSObjectProtocol {
        #[cfg(all(
            feature = "FSItem",
        ...
        unsafe fn blockmapFile_offset_length_flags_operationID_packer_replyHandler(
            ...
            operation_id: FSOperationID,
            packer: &FSExtentPacker,
            reply: &block2::SendableBlock<'static, fn(*mut FSBlockmapResult, *mut NSError)>,
        );
        ...
        unsafe fn completeIOForFile_offset_length_status_flags_operationID_replyHandler(
            ...
            flags: FSCompleteIOFlags,
            operation_id: FSOperationID,
            reply: &block2::SendableBlock<'static, fn(*mut FSCompleteIOResult, *mut NSError)>,
        );
        ...
        #[unsafe(method(createFileNamed:inDirectory:attributes:packer:context:replyHandler:))]
        #[unsafe(method_family = none)]
        unsafe fn createFileNamed_inDirectory_attributes_packer_context_replyHandler(
            &self,
            name: &FSFileName,
            directory: &FSItem,
            ...
            packer: &FSExtentPacker,
            context: &FSContext,
            reply: &block2::SendableBlock<'static, fn(*mut FSCreateFileKOIOResult, *mut NSError)>,
        );
        ...
        #[unsafe(method(lookupItemNamed:inDirectory:packer:context:replyHandler:))]
        #[unsafe(method_family = none)]
        unsafe fn lookupItemNamed_inDirectory_packer_context_replyHandler(
            &self,
            name: &FSFileName,
            directory: &FSItem,
            packer: &FSExtentPacker,
            context: &FSContext,
            reply: &block2::SendableBlock<'static, fn(*mut FSLookupItemKOIOResult, *mut NSError)>,
        );
        ...
        #[optional]
        #[unsafe(method(preallocateSpaceForFile:atOffset:length:flags:packer:context:replyHandler:))]
        #[unsafe(method_family = none)]
        unsafe fn preallocateSpaceForFile_atOffset_length_flags_packer_context_replyHandler(
            &self,
            file: &FSItem,
            offset: libc::off_t,
            length: usize,
            ...
            packer: &FSExtentPacker,
            context: &FSContext,
            reply: &block2::SendableBlock<'static, fn(*mut FSPreallocateKOIOResult, *mut NSError)>,
        );
    }
);
