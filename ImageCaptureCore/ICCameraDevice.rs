    ...
    extern_methods!(
        ...
        pub unsafe fn requestDeleteFiles_deleteFailed_completion(
            ...
            delete_failed: &block2::Block<
                'static,
                fn(NonNull<NSDictionary<ICDeleteError, ICCameraItem>>),
            >,
            completion: &block2::Block<
                'static,
                fn(NonNull<NSDictionary<ICDeleteResult, NSArray<ICCameraItem>>>, *mut NSError),
            >,
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn ptpEventHandler(
            &self,
        ) -> NonNull<block2::Block<'static, fn(NonNull<NSData>)>>;
        ...
        pub unsafe fn setPtpEventHandler(
            &self,
            ptp_event_handler: &block2::Block<'static, fn(NonNull<NSData>)>,
        );
