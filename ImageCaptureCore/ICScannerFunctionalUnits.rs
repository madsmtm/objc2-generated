...
extern_class!(
    ...
    /// ## Overview
    ///
    /// The ImageCaptureCore framework defines three concrete subclasses of scanner features: [`ICScannerFeatureEnumeration`](https://developer.apple.com/documentation/imagecapturecore/icscannerfeatureenumeration), [`ICScannerFeatureRange`](https://developer.apple.com/documentation/imagecapturecore/icscannerfeaturerange), and [`ICScannerFeatureBoolean`](https://developer.apple.com/documentation/imagecapturecore/icscannerfeatureboolean). Scanner functional units may have one or more instances of these classes to allow users to choose scanner-specific settings or operations before performing a scan.
    ///
    ///
...
extern_class!(
    ...
    ///
    /// - [`ICScannerFunctionalUnitDocumentFeeder`](https://developer.apple.com/documentation/imagecapturecore/icscannerfunctionalunitdocumentfeeder)
    ///
    /// - [`ICScannerFunctionalUnitFlatbed`](https://developer.apple.com/documentation/imagecapturecore/icscannerfunctionalunitflatbed)
    ///
    /// - [`ICScannerFunctionalUnitPositiveTransparency`](https://developer.apple.com/documentation/imagecapturecore/icscannerfunctionalunitpositivetransparency)
    ///
    /// - [`ICScannerFunctionalUnitNegativeTransparency`](https://developer.apple.com/documentation/imagecapturecore/icscannerfunctionalunitnegativetransparency)
    ///
    /// [`ICScannerDevice`](https://developer.apple.com/documentation/imagecapturecore/icscannerdevice) creates instances of these subclasses.
    ///
    ///
