...
extern_methods!(
    unsafe impl CMWaterSubmersionMeasurement {
        ...
        pub unsafe fn depth(&self) -> Option<Id<NSMeasurement<NSUnitLength>>>;

        #[method_id(@__retain_semantics Other pressure)]
        pub unsafe fn pressure(&self) -> Option<Id<NSMeasurement<NSUnitPressure>>>;

        #[method_id(@__retain_semantics Other surfacePressure)]
        pub unsafe fn surfacePressure(&self) -> Id<NSMeasurement<NSUnitPressure>>;
...
extern_methods!(
    unsafe impl CMWaterTemperature {
        ...
        pub unsafe fn temperatureUncertainty(&self) -> Id<NSMeasurement<NSUnitTemperature>>;
    }
);
