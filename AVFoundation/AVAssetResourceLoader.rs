...
extern_methods!(
    unsafe impl AVAssetResourceLoadingRequest {
        ...
        #[method(contentInformationRequest)]
        #[unsafe(method_family = none)]
...
extern_methods!(
    ...
    unsafe impl AVAssetResourceLoadingRequest {
        ...
        #[method(streamingContentKeyRequestDataForApp:contentIdentifier:options:error:_)]
        #[unsafe(method_family = none)]
        ...
        #[method(persistentContentKeyFromKeyVendorResponse:options:error:_)]
        #[unsafe(method_family = none)]
