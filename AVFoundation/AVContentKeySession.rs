...
extern_methods!(
    unsafe impl AVContentKeySession {
        ...
        #[method_id(contentKeySessionWithKeySystem:)]
        ...
        /// This method returns an AVContentKeySession instance that is capable of managing collection of media content keys corresponding to the input keySystem. An NSInvalidArgumentException will be raised if the value of keySystem is unsupported.
        #[unsafe(method_family(none))]
        #[method_id(contentKeySessionWithKeySystem:storageDirectoryAtURL:)]
        ...
        #[unsafe(method_family(none))]
        #[method_id(contentProtectionSessionIdentifier)]
...
extern_methods!(
    ...
    unsafe impl AVContentKeySession {
        ...
        #[unsafe(method_family(none))]
        #[method_id(contentKeyRecipients)]
...
extern_methods!(
    ...
    unsafe impl AVContentKeySession {
        ...
        #[unsafe(method_family(none))]
        #[method_id(pendingExpiredSessionReportsWithAppIdentifier:storageDirectoryAtURL:)]
...
extern_methods!(
    unsafe impl AVPersistableContentKeyRequest {
        ...
        #[unsafe(method_family(none))]
        #[method_id(persistableContentKeyFromKeyVendorResponse:options:error:_)]
...
extern_methods!(
    unsafe impl AVContentKeyResponse {
        ...
        #[unsafe(method_family(none))]
        #[method_id(contentKeyResponseWithFairPlayStreamingKeyResponseData:)]
        ...
        #[unsafe(method_family(none))]
        #[method_id(contentKeyResponseWithClearKeyData:initializationVector:)]
        ...
        #[unsafe(method_family(none))]
        #[method_id(contentKeyResponseWithAuthorizationTokenData:)]
...
extern_methods!(
    unsafe impl AVContentKeySpecifier {
        ...
        #[unsafe(method_family(none))]
        #[method_id(contentKeySpecifierForKeySystem:identifier:options:)]
        ...
        /// This method returns an AVContentKeySpecifier instance that represents a content key in a specific content key system.
        #[unsafe(method_family(init))]
        #[method_id(initForKeySystem:identifier:options:)]
