...
extern_protocol!(
    ...
    pub unsafe trait PKPushRegistryDelegate: NSObjectProtocol {
        ...
        #[cfg(all(
            feature = "PKPushPayload",
            feature = "PKVoIPPushMetadata",
            feature = "block2"
        ))]
        ...
        ///
        /// <doc
        /// ://com.apple.documentation/documentation/livecommunicationkit/conversationmanager/reportnewincomingconversation(uuid:update:)>
        ///
        ...
        #[unsafe(method_family = none)]
        unsafe fn pushRegistry_didReceiveIncomingVoIPPushWithPayload_metadata_withCompletionHandler(
            &self,
            registry: &PKPushRegistry,
            payload: &PKPushPayload,
