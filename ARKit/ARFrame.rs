...
extern_methods!(
    ...
    unsafe impl ARFrame {
        ...
        #[method(raycastQueryFromPoint:allowingTarget:alignment:)]
        #[unsafe(method_family = none)]
