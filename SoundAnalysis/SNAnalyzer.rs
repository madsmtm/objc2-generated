...
impl SNAudioStreamAnalyzer {
    extern_methods!(
        ...
        #[unsafe(method(addRequest:withObserver:error:_))]
        ...
        #[unsafe(method(analyzeAudioBuffer:atAudioFramePosition:))]
        #[unsafe(method_family = none)]
