...
impl SNClassifySoundRequest {
    extern_methods!(
        ...
        #[unsafe(method(windowDurationConstraint))]
        #[unsafe(method_family = none)]
        ...
        #[unsafe(method(knownClassifications))]
        #[unsafe(method_family = none)]
        ...
        #[unsafe(method(initWithMLModel:error:_))]
        ...
        #[unsafe(method(initWithClassifierIdentifier:error:_))]
        #[unsafe(method_family = init)]
