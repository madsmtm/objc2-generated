...
extern_methods!(
    unsafe impl EKVirtualConferenceRoomTypeDescriptor {
        ...
        #[method_id(initWithTitle:identifier:)]
...
extern_methods!(
    unsafe impl EKVirtualConferenceDescriptor {
        ...
        #[method_id(initWithTitle:URLDescriptors:conferenceDetails:)]
        #[unsafe(method_family = init)]
