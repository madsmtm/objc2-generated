...
extern_class!(
    ...
    /// ## Overview
    ///
    /// You must present action sheets modally by calling the [`presentTemplate:animated:completion:`](https://developer.apple.com/documentation/carplay/cpinterfacecontroller/presenttemplate(_:animated:completion:)) method available on your app’s instance of [`CPInterfaceController`](https://developer.apple.com/documentation/carplay/cpinterfacecontroller). The user dismisses the action sheet by pressing a button, or you can dismiss it by calling the interface controller’s [`dismissTemplateAnimated:completion:`](https://developer.apple.com/documentation/carplay/cpinterfacecontroller/dismisstemplate(animated:completion:)) method.
    ///
    ///
