...
#[cfg(feature = "block2")]
pub type PGDisplayNewFrameEventHandler = block2::Block<'static, fn()>;
...
#[cfg(feature = "block2")]
pub type PGDisplayCursorShowHandler = block2::Block<'static, fn(Bool)>;
...
#[cfg(feature = "block2")]
pub type PGDisplayCursorMoveHandler = block2::Block<'static, fn()>;
