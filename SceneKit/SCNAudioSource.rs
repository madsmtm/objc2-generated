...
impl SCNAudioPlayer {
    extern_methods!(
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn willStartPlayback(&self) -> *mut block2::Block<'static, fn()>;
        ...
        pub unsafe fn setWillStartPlayback(
            &self,
            will_start_playback: Option<&block2::Block<'static, fn()>>,
        );
        ...
        #[unsafe(method_family = none)]
        pub unsafe fn didFinishPlayback(&self) -> *mut block2::Block<'static, fn()>;
        ...
        pub unsafe fn setDidFinishPlayback(
            &self,
            did_finish_playback: Option<&block2::Block<'static, fn()>>,
        );
