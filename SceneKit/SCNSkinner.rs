...
extern_methods!(
    unsafe impl SCNSkinner {
        ...
        #[method_id(@__retain_semantics Other skinnerWithBaseGeometry:bones:boneInverseBindTransforms:boneWeights:boneIndices:)]
        ...
        #[method_id(@__retain_semantics Other baseGeometry)]
