...
impl SCNTransformConstraint {
    extern_methods!(
        ...
        pub unsafe fn transformConstraintInWorldSpace_withBlock(
            world: bool,
            block: &block2::Block<'static, fn(NonNull<SCNNode>, SCNMatrix4) -> SCNMatrix4>,
        ) -> Retained<Self>;
        ...
        pub unsafe fn positionConstraintInWorldSpace_withBlock(
            world: bool,
            block: &block2::Block<'static, fn(NonNull<SCNNode>, SCNVector3) -> SCNVector3>,
        ) -> Retained<Self>;
        ...
        pub unsafe fn orientationConstraintInWorldSpace_withBlock(
            world: bool,
            block: &block2::Block<'static, fn(NonNull<SCNNode>, SCNQuaternion) -> SCNQuaternion>,
        ) -> Retained<Self>;
    );
}
