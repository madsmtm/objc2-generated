...
extern_methods!(
    unsafe impl VNRequest {
        ...
        #[method_id(@__method_family Other supportedRevisions)]
...
extern_methods!(
    unsafe impl VNRequest {
        ...
        #[method_id(@__method_family Other supportedComputeStageDevicesAndReturnError:_)]
        ...
        #[method_id(@__method_family Other computeDeviceForComputeStage:)]
