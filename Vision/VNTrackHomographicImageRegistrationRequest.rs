...
extern_class!(
    ...
    /// ## Overview
    ///
    /// This request is similar to [`VNHomographicImageRegistrationRequest`](https://developer.apple.com/documentation/vision/vnhomographicimageregistrationrequest). However, as a [`VNStatefulRequest`](https://developer.apple.com/documentation/vision/vnstatefulrequest), it automatically computes the registration against the previous frame.
    ///
    ///
