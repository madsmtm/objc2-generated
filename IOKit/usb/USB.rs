...
/// [Apple's documentation](https://developer.apple.com/documentation/iokit/kusballstreams?language=objc)
pub const kUSBAllStreams: c_long = 0xffffffff;
