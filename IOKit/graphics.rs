...
pub unsafe extern "C-unwind" fn IODisplayMatchDictionaries(
    ...
    unsafe { IODisplayMatchDictionaries(matching1, matching2, options) }
}
...
pub unsafe extern "C-unwind" fn IODisplaySetFloatParameter(
    ...
    unsafe { IODisplaySetFloatParameter(service, options, parameter_name, value) }
}
...
pub unsafe extern "C-unwind" fn IODisplaySetIntegerParameter(
    ...
    extern "C-unwind" {
        fn IODisplaySetIntegerParameter(
            service: io_service_t,
            options: IOOptionBits,
            parameter_name: Option<&CFString>,
            value: i32,
    ...
    unsafe { IODisplaySetIntegerParameter(service, options, parameter_name, value) }
}
