...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckrecordtype?language=objc)
pub type CKRecordType = NSString;

/// A data type that CloudKit requires for record field names.
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckrecordfieldkey?language=objc)
...
extern_protocol!(
    ...
    /// -
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nsdate>
    /// -
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nsdata>
    /// - ``CKRecord/Reference``
    /// - ``CKAsset``
    /// -
    /// <doc
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckrecordvalue?language=objc)
...
extern_class!(
    ...
    /// - term
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nsstring>: Stores relatively small amounts of text. Although strings themselves can be any length, use a ``CKAsset`` to store large amounts of text.
    /// - term
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nsnumber>: Stores any numerical information, including integers and floating-point numbers.
    /// - term
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nsdata>: Stores arbitrary bytes of data. A typical use for data objects is to map the bytes that they contain to a `struct`. Don't use data objects for storing large binary data files; use a ``CKAsset`` instead. Data fields aren't searchable.
    /// - term
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nsdate>: Stores day and time information in an accessible form.
    /// - term
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nsarray>: Stores one or more objects of any other type in this table. You can store arrays of strings, arrays of numbers, arrays of references, and so on.
    /// - term
    /// <doc
    /// ://com.apple.documentation/documentation/corelocation/cllocation>: Stores geographic coordinate data. You use locations in conjunction with the Core Location framework and any other services that handle location information.
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckrecord?language=objc)
...
impl CKRecord {
    extern_methods!(
        ...
        ///
        /// New records don't contain any keys or values. Values are always one of the data types in
        /// <doc
        /// :CKRecord#Supported-Data-Types>.
        ///
        ...
        ///
        /// - Parameters:
        /// - object: The object to store using the specified key. The value you provide must be an instance of one the data types in
        /// <doc
        /// :CKRecord#Supported-Data-Types>. You receive an error if you use a data type that CloudKit doesn't support. If you specify `nil`, CloudKit removes any object that the record associates with the key.
        ...
        ///
        /// If the type of the `object` parameter differs from the type of the object that's on the server, you encounter an error when you attempt to save this record to the server. For example, if the current value is an
        /// <doc
        /// ://com.apple.documentation/documentation/foundation/nsstring> object, you receive an error if you change the value to an
        /// <doc
        /// ://com.apple.documentation/documentation/foundation/nsnumber> object and save the record.
        ///
        ...
        ///
        /// - Parameters:
        /// - object: The object to store using the specified key. It must be one of the data types in
        /// <doc
        /// :CKRecord#Supported-Data-Types>. You receive an error if you use a data type that CloudKit doesn't support. If you specify `nil`, CloudKit removes any object that the record associates with the key.
        /// - key: The key to associate with `object`. Use this key to retrieve the value later. A key must consist of one or more alphanumeric characters and must start with a letter. CloudKit permits the use of underscores, but not spaces. Avoid using a key that matches the name of any property of `CKRecord`.
        ///
