...
impl CKNotificationType {
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/cknotification/notificationtype-swift.enum/query?language=objc)
    #[doc(alias = "CKNotificationTypeQuery")]
    pub const Query: Self = Self(1);
    /// Generated by ``CKRecordZoneSubscription``s
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/cknotification/notificationtype-swift.enum/recordzone?language=objc)
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/cknotification/notificationtype-swift.enum/readnotification?language=objc)
    #[doc(alias = "CKNotificationTypeReadNotification")]
    pub const ReadNotification: Self = Self(3);
    /// Generated by ``CKDatabaseSubscription``s
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/cknotification/notificationtype-swift.enum/database?language=objc)
...
impl CKQueryNotificationReason {
    /// [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckquerynotification/reason/recordcreated?language=objc)
    #[doc(alias = "CKQueryNotificationReasonRecordCreated")]
    pub const RecordCreated: Self = Self(1);
    /// [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckquerynotification/reason/recordupdated?language=objc)
    #[doc(alias = "CKQueryNotificationReasonRecordUpdated")]
    pub const RecordUpdated: Self = Self(2);
    /// [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckquerynotification/reason/recorddeleted?language=objc)
