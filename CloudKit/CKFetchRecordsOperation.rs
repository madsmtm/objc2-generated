...
impl CKFetchRecordsOperation {
    extern_methods!(
        ...
        pub unsafe fn perRecordProgressBlock(
            &self,
        ) -> *mut block2::Block<'static, fn(NonNull<CKRecordID>, c_double)>;
        ...
        pub unsafe fn setPerRecordProgressBlock(
            ...
            per_record_progress_block: Option<
                &block2::Block<'static, fn(NonNull<CKRecordID>, c_double)>,
            >,
        );
        ...
        pub unsafe fn perRecordCompletionBlock(
            &self,
        ) -> *mut block2::Block<'static, fn(*mut CKRecord, *mut CKRecordID, *mut NSError)>;
        ...
        pub unsafe fn setPerRecordCompletionBlock(
            ...
            per_record_completion_block: Option<
                &block2::Block<'static, fn(*mut CKRecord, *mut CKRecordID, *mut NSError)>,
            >,
        );
        ...
        pub unsafe fn fetchRecordsCompletionBlock(
            &self,
        ) -> *mut block2::Block<'static, fn(*mut NSDictionary<CKRecordID, CKRecord>, *mut NSError)>;
        ...
        pub unsafe fn setFetchRecordsCompletionBlock(
            ...
            fetch_records_completion_block: Option<
                &block2::Block<'static, fn(*mut NSDictionary<CKRecordID, CKRecord>, *mut NSError)>,
            >,
        );
    );
}
