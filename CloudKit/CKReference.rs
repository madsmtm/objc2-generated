...
///
/// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckreferenceaction?language=objc)
// NS_ENUM
#[repr(transparent)]
...
extern_class!(
    ...
    /// , recordToMatch];
    /// // Create the query object.
    /// CKQuery* query = [[CKQuery alloc] initWithRecordType:
    /// "
    ...
    /// }
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckreference?language=objc)
