...
extern_class!(
    ...
    ///
    /// Change tokens conform to
    /// <doc
    /// ://com.apple.documentation/documentation/foundation/nssecurecoding> and are safe to cache on-disk, as the following example shows:
    ///
    /// ```swift
    ...
    /// ```
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/cloudkit/ckserverchangetoken?language=objc)
