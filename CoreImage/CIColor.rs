...
extern_class!(
    ...
    /// ## Overview
    ///
    /// Use `CIColor` instances in conjunction with other Core Image classes, such as [`CIFilter`](https://developer.apple.com/documentation/coreimage/cifilter-swift.class) and [`CIKernel`](https://developer.apple.com/documentation/coreimage/cikernel). Many of the built-in Core Image filters have one or more `CIColor` inputs that you can set to affect the filter’s behavior.
    ///
    /// ### Color Model
    ///
