...
extern_methods!(
    unsafe impl CIVector {
        ...
        pub unsafe fn vectorWithValues_count(values: NonNull<CGFloat>, count: usize) -> Id<Self>;

        #[method_id(@__retain_semantics Other vectorWithX:)]
        pub unsafe fn vectorWithX(x: CGFloat) -> Id<Self>;

        #[method_id(@__retain_semantics Other vectorWithX:Y:)]
        pub unsafe fn vectorWithX_Y(x: CGFloat, y: CGFloat) -> Id<Self>;

        #[method_id(@__retain_semantics Other vectorWithX:Y:Z:)]
        pub unsafe fn vectorWithX_Y_Z(x: CGFloat, y: CGFloat, z: CGFloat) -> Id<Self>;

        #[method_id(@__retain_semantics Other vectorWithX:Y:Z:W:)]
        pub unsafe fn vectorWithX_Y_Z_W(x: CGFloat, y: CGFloat, z: CGFloat, w: CGFloat)
            -> Id<Self>;

        #[method_id(@__retain_semantics Other vectorWithCGPoint:)]
        pub unsafe fn vectorWithCGPoint(p: CGPoint) -> Id<Self>;

        #[method_id(@__retain_semantics Other vectorWithCGRect:)]
        pub unsafe fn vectorWithCGRect(r: CGRect) -> Id<Self>;

        #[method_id(@__retain_semantics Other vectorWithString:)]
        pub unsafe fn vectorWithString(representation: &NSString) -> Id<Self>;
        ...
        pub unsafe fn initWithX(this: Allocated<Self>, x: CGFloat) -> Id<Self>;

        #[method_id(@__retain_semantics Init initWithX:Y:)]
        pub unsafe fn initWithX_Y(this: Allocated<Self>, x: CGFloat, y: CGFloat) -> Id<Self>;
        ...
        pub unsafe fn initWithCGPoint(this: Allocated<Self>, p: CGPoint) -> Id<Self>;

        #[method_id(@__retain_semantics Init initWithCGRect:)]
        pub unsafe fn initWithCGRect(this: Allocated<Self>, r: CGRect) -> Id<Self>;

        #[method_id(@__retain_semantics Init initWithString:)]
        pub unsafe fn initWithString(this: Allocated<Self>, representation: &NSString) -> Id<Self>;
