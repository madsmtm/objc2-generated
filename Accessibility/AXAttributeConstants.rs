...
extern "C" {
    /// Annotate a range of an accessibility NSAttributedString with a
    ...
    /// it in a top-level
    /// <speak
    /// > element. The text spoken for the range is derived
    ...
    ///
    /// See also [Apple's documentation](https://developer.apple.com/documentation/accessibility/axspeechattributessml?language=objc)
    pub static AXSpeechAttributeSSML: &'static NSAttributedStringKey;
}
