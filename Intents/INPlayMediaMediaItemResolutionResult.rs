...
/// [Apple's documentation](https://developer.apple.com/documentation/intents/inplaymediamediaitemunsupportedreason?language=objc)
// NS_ENUM
#[repr(transparent)]
...
unsafe impl Encode for INPlayMediaMediaItemUnsupportedReason {
    const ENCODING: Encoding = NSInteger::ENCODING;
}

unsafe impl RefEncode for INPlayMediaMediaItemUnsupportedReason {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}

extern_class!(
    /// [Apple's documentation](https://developer.apple.com/documentation/intents/inplaymediamediaitemresolutionresult?language=objc)
    ...
    pub struct INPlayMediaMediaItemResolutionResult;
);
...
impl INPlayMediaMediaItemResolutionResult {
    extern_methods!(
        ...
        ) -> Retained<NSArray<INPlayMediaMediaItemResolutionResult>>;

        #[unsafe(method(unsupportedForReason:))]
        #[unsafe(method_family = none)]
        pub unsafe fn unsupportedForReason(
            reason: INPlayMediaMediaItemUnsupportedReason,
        ) -> Retained<Self>;
