...
extern_protocol!(
    ...
    pub unsafe trait INStartWorkoutIntentHandling: NSObjectProtocol {
        ...
        ///
        /// Parameter `completion`: The response handling block takes a INStartWorkoutIntentResponse containing the details of the result of having executed the intent
        ///
        ///
        ...
        unsafe fn handleStartWorkout_completion(
            ...
            completion: &block2::Block<dyn Fn(NonNull<INStartWorkoutIntentResponse>)>,
        );
        ...
        /// Parameter `intent`: The input intent
        ///
        /// Parameter `completion`: The response block contains an INStartWorkoutIntentResponse containing additional details about the intent that may be relevant for the system to show the user prior to handling.
        ///
        ///
        /// See: INStartWorkoutIntentResponse
        #[optional]
        ...
        unsafe fn resolveWorkoutGoalUnitTypeForStartWorkout_withCompletion(
            &self,
            intent: &INStartWorkoutIntent,
            completion: &block2::Block<dyn Fn(NonNull<INWorkoutGoalUnitTypeResolutionResult>)>,
        );
        ...
        unsafe fn resolveWorkoutLocationTypeForStartWorkout_withCompletion(
            &self,
            intent: &INStartWorkoutIntent,
            completion: &block2::Block<dyn Fn(NonNull<INWorkoutLocationTypeResolutionResult>)>,
        );
