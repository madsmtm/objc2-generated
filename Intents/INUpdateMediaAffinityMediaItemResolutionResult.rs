...
unsafe impl Encode for INUpdateMediaAffinityMediaItemUnsupportedReason {
    const ENCODING: Encoding = NSInteger::ENCODING;
}

unsafe impl RefEncode for INUpdateMediaAffinityMediaItemUnsupportedReason {
...
extern_class!(
    ...
    pub struct INUpdateMediaAffinityMediaItemResolutionResult;
);
...
unsafe impl NSObjectProtocol for INUpdateMediaAffinityMediaItemResolutionResult {}

#[cfg(all(
    feature = "INIntentResolutionResult",
    feature = "INMediaItemResolutionResult"
))]
impl INUpdateMediaAffinityMediaItemResolutionResult {
    extern_methods!(
        ...
        ) -> Retained<NSArray<INUpdateMediaAffinityMediaItemResolutionResult>>;

        #[unsafe(method(unsupportedForReason:))]
        #[unsafe(method_family = none)]
        pub unsafe fn unsupportedForReason(
            reason: INUpdateMediaAffinityMediaItemUnsupportedReason,
        ) -> Retained<Self>;
