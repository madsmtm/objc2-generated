...
extern_class!(
    ...
    pub struct INUpdateMediaAffinityIntent;
);
...
impl INUpdateMediaAffinityIntent {
    extern_methods!(
        #[cfg(all(
            feature = "INMediaAffinityType",
            feature = "INMediaItem",
            feature = "INMediaSearch"
        ))]
        #[unsafe(method(initWithMediaItems:mediaSearch:affinityType:))]
        #[unsafe(method_family = init)]
        pub unsafe fn initWithMediaItems_mediaSearch_affinityType(
            this: Allocated<Self>,
            media_items: Option<&NSArray<INMediaItem>>,
            media_search: Option<&INMediaSearch>,
            affinity_type: INMediaAffinityType,
        ) -> Retained<Self>;
        ...
        #[unsafe(method(affinityType))]
        #[unsafe(method_family = none)]
        pub unsafe fn affinityType(&self) -> INMediaAffinityType;
    );
}
...
extern_protocol!(
    ...
    pub unsafe trait INUpdateMediaAffinityIntentHandling: NSObjectProtocol {
        ...
        ///
        /// Parameter `completion`: The response handling block takes a INUpdateMediaAffinityIntentResponse containing the details of the result of having executed the intent
        ///
        ///
        ...
        unsafe fn handleUpdateMediaAffinity_completion(
            ...
            completion: &block2::Block<dyn Fn(NonNull<INUpdateMediaAffinityIntentResponse>)>,
        );
        ...
        /// Parameter `intent`: The input intent
        ///
        /// Parameter `completion`: The response block contains an INUpdateMediaAffinityIntentResponse containing additional details about the intent that may be relevant for the system to show the user prior to handling.
        ///
        ///
        /// See: INUpdateMediaAffinityIntentResponse
        #[optional]
        ...
        unsafe fn resolveAffinityTypeForUpdateMediaAffinity_withCompletion(
            &self,
            intent: &INUpdateMediaAffinityIntent,
            completion: &block2::Block<dyn Fn(NonNull<INMediaAffinityTypeResolutionResult>)>,
        );
    }
);
