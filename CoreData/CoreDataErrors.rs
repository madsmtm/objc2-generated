...
extern_static!(NSDetailedErrorsKey: &'static Foundation::NSString);

extern_static!(NSValidationObjectErrorKey: &'static Foundation::NSString);

extern_static!(NSValidationKeyErrorKey: &'static Foundation::NSString);

extern_static!(NSValidationPredicateErrorKey: &'static Foundation::NSString);

extern_static!(NSValidationValueErrorKey: &'static Foundation::NSString);

extern_static!(NSAffectedStoresErrorKey: &'static Foundation::NSString);

extern_static!(NSAffectedObjectsErrorKey: &'static Foundation::NSString);

extern_static!(NSPersistentStoreSaveConflictsErrorKey: &'static Foundation::NSString);

extern_static!(NSSQLiteErrorDomain: &'static Foundation::NSString);
