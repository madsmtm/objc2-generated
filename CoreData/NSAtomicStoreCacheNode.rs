...
extern_methods!(
    ...
    unsafe impl NSAtomicStoreCacheNode {
        ...
        pub unsafe fn initWithObjectID(
            ...
            moid: &CoreData::NSManagedObjectID,
        ) -> Id<Self, Shared>;
        ...
        pub unsafe fn propertyCache(
            &self,
        ) -> Option<Id<Foundation::NSMutableDictionary<Foundation::NSString, Object>, Owned>>;
        ...
        pub unsafe fn setPropertyCache(
            &self,
            propertyCache: Option<&Foundation::NSMutableDictionary<Foundation::NSString, Object>>,
        );
