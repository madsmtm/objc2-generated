...
extern_class!(
    ...
    unsafe impl ClassType for NSPersistentCloudKitContainer {
        #[inherits(NSObject)]
        type Super = CoreData::NSPersistentContainer;
    }
);
...
extern_methods!(
    ...
    unsafe impl NSPersistentCloudKitContainer {
        ...
        pub unsafe fn initializeCloudKitSchemaWithOptions_error(
            &self,
            options: CoreData::NSPersistentCloudKitContainerSchemaInitializationOptions,
        ...
        pub unsafe fn canModifyManagedObjectsInStore(
            &self,
...
extern_methods!(
    ...
    #[cfg(feature = "CoreData_NSPersistentCloudKitContainer")]
    unsafe impl CoreData::NSPersistentCloudKitContainer {
