...
/// ## Overview
///
/// These constants are used by [`resultType`](https://developer.apple.com/documentation/coredata/nsfetchrequest/resulttype).
///
///
// NS_OPTIONS
#[repr(transparent)]
...
/// ## Discussion
///
/// See also [`includesPendingChanges`](https://developer.apple.com/documentation/coredata/nsfetchrequest/includespendingchanges) and [`propertiesToFetch`](https://developer.apple.com/documentation/coredata/nsfetchrequest/propertiestofetch).
///
///
...
extern_class!(
    ...
    ///
    /// - [`fetchLimit`](https://developer.apple.com/documentation/coredata/nsfetchrequest/fetchlimit): The maximum number of objects that a request returns
    ///
    /// - [`fetchOffset`](https://developer.apple.com/documentation/coredata/nsfetchrequest/fetchoffset): The number of objects to skip
    ///
    /// - [`affectedStores`](https://developer.apple.com/documentation/coredata/nsfetchrequest/affectedstores): Which data stores the request accesses
    ///
    /// - [`resultType`](https://developer.apple.com/documentation/coredata/nsfetchrequest/resulttype): Whether the fetch returns managed objects, object IDs, dictionaries, or a count
    ///
    /// - [`includesPropertyValues`](https://developer.apple.com/documentation/coredata/nsfetchrequest/includespropertyvalues) and: Whether objects are fully populated with their properties
    ///
    /// - [`returnsObjectsAsFaults`](https://developer.apple.com/documentation/coredata/nsfetchrequest/returnsobjectsasfaults): Whether the objects are faults
    ///
    /// - [`includesSubentities`](https://developer.apple.com/documentation/coredata/nsfetchrequest/includessubentities): Whether the fetch includes subentities of the fetched entity
    ///
    /// - [`propertiesToFetch`](https://developer.apple.com/documentation/coredata/nsfetchrequest/propertiestofetch): Which properties to fetch
    ///
    /// - [`includesPendingChanges`](https://developer.apple.com/documentation/coredata/nsfetchrequest/includespendingchanges): Whether to include unsaved changes
    ///
    /// Use [`execute:`](https://developer.apple.com/documentation/coredata/nsfetchrequest/execute()) to perform the fetch directly on the managed object context that’s associated with the current queue. Or use one of the [`NSManagedObjectContext`](https://developer.apple.com/documentation/coredata/nsmanagedobjectcontext) methods such as [`performBlock:`](https://developer.apple.com/documentation/coredata/nsmanagedobjectcontext/perform(_:)) to execute the fetch.
    ///
    /// <div class="warning">
    ///
    /// ### Note
    ///  When you execute an instance of [`NSFetchRequest`](https://developer.apple.com/documentation/coredata/nsfetchrequest), it always accesses the underlying persistent stores to retrieve the latest results.
    ///
    ///
    ///
    /// </div>
