...
extern_methods!(
    ...
    unsafe impl NSFetchIndexDescription {
        ...
        pub unsafe fn initWithName_elements(
            ...
            elements: Option<&Foundation::NSArray<CoreData::NSFetchIndexElementDescription>>,
        ) -> Id<Self, Shared>;
        ...
        pub unsafe fn elements(
            &self,
        ) -> Id<Foundation::NSArray<CoreData::NSFetchIndexElementDescription>, Shared>;
        ...
        #[method(setElements:)]
        pub unsafe fn setElements(
            &self,
            elements: &Foundation::NSArray<CoreData::NSFetchIndexElementDescription>,
        );
        ...
        pub unsafe fn partialIndexPredicate(&self) -> Option<Id<Foundation::NSPredicate, Shared>>;

        #[cfg(feature = "Foundation_NSPredicate")]
        #[method(setPartialIndexPredicate:)]
        pub unsafe fn setPartialIndexPredicate(
            &self,
            partialIndexPredicate: Option<&Foundation::NSPredicate>,
        );
    }
);
