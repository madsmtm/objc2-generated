...
extern_methods!(
    ...
    unsafe impl NSBatchUpdateRequest {
        #[method_id(@__method_family Other batchUpdateRequestWithEntityName:)]
        ...
        #[method_id(@__method_family Init initWithEntity:)]
        ...
        #[method_id(@__method_family Other propertiesToUpdate)]
