...
extern_methods!(
    ...
    unsafe impl NSPersistentContainer {
        ...
        pub unsafe fn persistentContainerWithName(name: &Foundation::NSString) -> Id<Self, Shared>;
        ...
        pub unsafe fn defaultDirectoryURL() -> Id<Foundation::NSURL, Shared>;
        ...
        pub unsafe fn viewContext(&self) -> Id<CoreData::NSManagedObjectContext, Shared>;
        ...
        pub unsafe fn persistentStoreCoordinator(
            &self,
        ) -> Id<CoreData::NSPersistentStoreCoordinator, Shared>;
        ...
        pub unsafe fn persistentStoreDescriptions(
            &self,
        ) -> Id<Foundation::NSArray<CoreData::NSPersistentStoreDescription>, Shared>;
        ...
        pub unsafe fn setPersistentStoreDescriptions(
            &self,
            persistentStoreDescriptions: &Foundation::NSArray<
        ...
        pub unsafe fn newBackgroundContext(&self) -> Id<CoreData::NSManagedObjectContext, Shared>;

        #[cfg(feature = "CoreData_NSManagedObjectContext")]
        #[method(performBackgroundTask:)]
        pub unsafe fn performBackgroundTask(
            &self,
            block: &Block<(NonNull<CoreData::NSManagedObjectContext>,), ()>,
        );
    }
);
