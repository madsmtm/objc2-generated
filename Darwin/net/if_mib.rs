...
unsafe impl Encode for ifmibdata {
...
unsafe impl RefEncode for ifmibdata {
...
unsafe impl Encode for ifs_iso_8802_3 {
    const ENCODING: Encoding = Encoding::Struct(
        "ifs_iso_8802_3",
        &[
            <u32>::ENCODING,
...
unsafe impl RefEncode for ifs_iso_8802_3 {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for dot3Vendors {
    const ENCODING: Encoding = c_uint::ENCODING;
}

unsafe impl RefEncode for dot3Vendors {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
