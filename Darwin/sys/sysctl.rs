...
unsafe impl Encode for ctlname {
    const ENCODING: Encoding =
        Encoding::Struct("ctlname", &[<*mut c_char>::ENCODING, <c_int>::ENCODING]);
}

unsafe impl RefEncode for ctlname {
...
unsafe impl Encode for _pcred {
    const ENCODING: Encoding = Encoding::Struct(
        "_pcred",
        &[
            <[c_char; 72]>::ENCODING,
            <*mut libc::ucred>::ENCODING,
            <libc::uid_t>::ENCODING,
            <libc::uid_t>::ENCODING,
            <libc::gid_t>::ENCODING,
            <libc::gid_t>::ENCODING,
...
unsafe impl RefEncode for _pcred {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl RefEncode for _ucred {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for eproc {
    const ENCODING: Encoding = Encoding::Struct(
        "eproc",
        &[
            <*mut libc::proc>::ENCODING,
            <*mut libc::session>::ENCODING,
            <libc::_pcred>::ENCODING,
            <libc::_ucred>::ENCODING,
            <libc::vmspace>::ENCODING,
            <libc::pid_t>::ENCODING,
            <libc::pid_t>::ENCODING,
            <c_short>::ENCODING,
            <libc::dev_t>::ENCODING,
...
unsafe impl RefEncode for eproc {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for kinfo_proc {
    const ENCODING: Encoding = Encoding::Struct(
        "kinfo_proc",
        &[<libc::extern_proc>::ENCODING, <libc::eproc>::ENCODING],
    );
}

unsafe impl RefEncode for kinfo_proc {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for xsw_usage {
    const ENCODING: Encoding = Encoding::Struct(
        "xsw_usage",
        &[
            <u64>::ENCODING,
...
unsafe impl RefEncode for xsw_usage {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for loadavg {
    const ENCODING: Encoding = Encoding::Struct(
        "loadavg",
        &[<[libc::fixpt_t; 3]>::ENCODING, Encoding::C_LONG],
    );
}

unsafe impl RefEncode for loadavg {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
