...
unsafe impl RefEncode for mbstat {
...
unsafe impl Encode for ombstat {
    const ENCODING: Encoding = Encoding::Struct(
        "ombstat",
        &[
            <u32>::ENCODING,
...
unsafe impl RefEncode for ombstat {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for mb_class_stat {
    const ENCODING: Encoding = Encoding::Struct(
        "mb_class_stat",
        &[
            <[c_char; 16]>::ENCODING,
...
unsafe impl RefEncode for mb_class_stat {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for mb_stat {
    const ENCODING: Encoding = Encoding::Struct(
        "mb_stat",
        &[
            <u32>::ENCODING,
            <u32>::ENCODING,
            <[libc::mb_class_stat_t; 1]>::ENCODING,
        ],
    );
}

unsafe impl RefEncode for mb_stat {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
