...
unsafe impl Encode for ipsecstat {
...
unsafe impl RefEncode for ipsecstat {
...
unsafe impl Encode for ipsec_wake_pkt_info {
    const ENCODING: Encoding = Encoding::Struct(
        "ipsec_wake_pkt_info",
        &[
            <[u8; 100]>::ENCODING,
            <libc::uuid_string_t>::ENCODING,
            <u32>::ENCODING,
            <u32>::ENCODING,
            <u16>::ENCODING,
        ],
...
unsafe impl RefEncode for ipsec_wake_pkt_info {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for ipsec_wake_pkt_event_data {
    const ENCODING: Encoding = Encoding::Struct(
...
unsafe impl RefEncode for ipsec_wake_pkt_event_data {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
