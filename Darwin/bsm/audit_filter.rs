...
pub type audit_filter_record_t = Option<
    unsafe extern "C-unwind" fn(*mut c_void, *mut libc::timespec, c_int, *mut libc::tokenstr_t),
>;
...
pub type audit_filter_rawrecord_t =
    Option<unsafe extern "C-unwind" fn(*mut c_void, *mut libc::timespec, *mut c_void, c_uint)>;
