...
unsafe impl RefEncode for flock {
...
unsafe impl Encode for flocktimeout {
    const ENCODING: Encoding = Encoding::Struct(
        "flocktimeout",
        &[<libc::flock>::ENCODING, <libc::timespec>::ENCODING],
    );
}

unsafe impl RefEncode for flocktimeout {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for radvisory {
    const ENCODING: Encoding =
        Encoding::Struct("radvisory", &[<libc::off_t>::ENCODING, <c_int>::ENCODING]);
}

unsafe impl RefEncode for radvisory {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for fsignatures {
    const ENCODING: Encoding = Encoding::Struct(
        "fsignatures",
        &[
            <libc::off_t>::ENCODING,
...
unsafe impl RefEncode for fsignatures {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for fsupplement {
    const ENCODING: Encoding = Encoding::Struct(
        "fsupplement",
        &[
            <libc::off_t>::ENCODING,
...
unsafe impl RefEncode for fsupplement {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for fchecklv {
    const ENCODING: Encoding = Encoding::Struct(
        "fchecklv",
        &[
            <libc::off_t>::ENCODING,
...
unsafe impl RefEncode for fchecklv {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for fgetsigsinfo {
    const ENCODING: Encoding = Encoding::Struct(
        "fgetsigsinfo",
        &[
            <libc::off_t>::ENCODING,
...
unsafe impl RefEncode for fgetsigsinfo {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl RefEncode for fstore {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for fpunchhole {
    const ENCODING: Encoding = Encoding::Struct(
        "fpunchhole",
        &[
            <c_uint>::ENCODING,
...
unsafe impl RefEncode for fpunchhole {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for ftrimactivefile {
    const ENCODING: Encoding = Encoding::Struct(
        "ftrimactivefile",
        &[<libc::off_t>::ENCODING, <libc::off_t>::ENCODING],
    );
}

unsafe impl RefEncode for ftrimactivefile {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for fspecread {
    const ENCODING: Encoding = Encoding::Struct(
        "fspecread",
        &[
            <c_uint>::ENCODING,
...
unsafe impl RefEncode for fspecread {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for fattributiontag {
    const ENCODING: Encoding = Encoding::Struct(
        "fattributiontag",
        &[
            <c_uint>::ENCODING,
            <c_ulonglong>::ENCODING,
            <[c_char; 255]>::ENCODING,
        ],
    );
}

unsafe impl RefEncode for fattributiontag {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for log2phys {
    const ENCODING: Encoding = Encoding::Struct(
        "log2phys",
        &[
            <c_uint>::ENCODING,
...
unsafe impl RefEncode for log2phys {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for filesec_property_t {
    const ENCODING: Encoding = c_uint::ENCODING;
}

unsafe impl RefEncode for filesec_property_t {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
