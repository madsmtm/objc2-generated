...
unsafe impl Encode for sa_endpoints {
    const ENCODING: Encoding = Encoding::Struct(
        "sa_endpoints",
        &[
            <c_uint>::ENCODING,
            <*const libc::sockaddr>::ENCODING,
...
unsafe impl RefEncode for sa_endpoints {
...
unsafe impl Encode for linger {
    const ENCODING: Encoding = Encoding::Struct("linger", &[<c_int>::ENCODING, <c_int>::ENCODING]);
}

unsafe impl RefEncode for linger {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for so_np_extensions {
    const ENCODING: Encoding =
        Encoding::Struct("so_np_extensions", &[<u32>::ENCODING, <u32>::ENCODING]);
}

unsafe impl RefEncode for so_np_extensions {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for sockaddr {
    const ENCODING: Encoding = Encoding::Struct(
        "sockaddr",
        &[
            <u8>::ENCODING,
...
unsafe impl RefEncode for sockaddr {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for __sockaddr_header {
    const ENCODING: Encoding = Encoding::Struct(
        "__sockaddr_header",
        &[<u8>::ENCODING, <libc::sa_family_t>::ENCODING],
    );
}

unsafe impl RefEncode for __sockaddr_header {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for sockproto {
    const ENCODING: Encoding = Encoding::Struct("sockproto", &[<u16>::ENCODING, <u16>::ENCODING]);
}

unsafe impl RefEncode for sockproto {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for sockaddr_storage {
    const ENCODING: Encoding = Encoding::Struct(
        "sockaddr_storage",
        &[
            <u8>::ENCODING,
...
unsafe impl RefEncode for sockaddr_storage {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for msghdr {
    const ENCODING: Encoding = Encoding::Struct(
        "msghdr",
        &[
            <*mut c_void>::ENCODING,
            <libc::socklen_t>::ENCODING,
            <*mut libc::iovec>::ENCODING,
            <c_int>::ENCODING,
            <*mut c_void>::ENCODING,
            <libc::socklen_t>::ENCODING,
            <c_int>::ENCODING,
...
unsafe impl RefEncode for msghdr {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for cmsghdr {
    const ENCODING: Encoding = Encoding::Struct(
        "cmsghdr",
        &[
            <libc::socklen_t>::ENCODING,
...
unsafe impl RefEncode for cmsghdr {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
...
unsafe impl Encode for sf_hdtr {
    const ENCODING: Encoding = Encoding::Struct(
        "sf_hdtr",
        &[
            <*mut libc::iovec>::ENCODING,
...
unsafe impl RefEncode for sf_hdtr {
    const ENCODING_REF: Encoding = Encoding::Pointer(&Self::ENCODING);
}
