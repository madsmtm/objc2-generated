...
extern_static!(ASExtensionErrorDomain: Option<&'static Foundation::NSErrorDomain>);
...
extern_static!(
    ASExtensionLocalizedFailureReasonErrorKey: Option<&'static Foundation::NSErrorUserInfoKey>
);
