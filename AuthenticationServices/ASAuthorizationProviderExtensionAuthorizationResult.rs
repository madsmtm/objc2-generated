...
extern_methods!(
    ...
    unsafe impl ASAuthorizationProviderExtensionAuthorizationResult {
        ...
        pub unsafe fn setHttpAuthorizationHeaders(
            &self,
            httpAuthorizationHeaders: Option<
        ...
        pub unsafe fn httpResponse(&self) -> Option<Id<Foundation::NSHTTPURLResponse, Shared>>;

        #[cfg(feature = "Foundation_NSHTTPURLResponse")]
        #[method(setHttpResponse:)]
        pub unsafe fn setHttpResponse(&self, httpResponse: Option<&Foundation::NSHTTPURLResponse>);
        ...
        pub unsafe fn privateKeys(&self) -> Id<Foundation::NSArray, Shared>;

        #[cfg(feature = "Foundation_NSArray")]
        #[method(setPrivateKeys:)]
        pub unsafe fn setPrivateKeys(&self, privateKeys: &Foundation::NSArray);
    }
);
