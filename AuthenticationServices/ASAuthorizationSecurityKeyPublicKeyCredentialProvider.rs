...
extern_methods!(
    ...
    unsafe impl ASAuthorizationSecurityKeyPublicKeyCredentialProvider {
        ...
        pub unsafe fn createCredentialRegistrationRequestWithChallenge_displayName_name_userID(&self, challenge: &Foundation::NSData,displayName: &Foundation::NSString,name: &Foundation::NSString,userID: &Foundation::NSData,) -> Id<AuthenticationServices::ASAuthorizationSecurityKeyPublicKeyCredentialRegistrationRequest, Shared>;
