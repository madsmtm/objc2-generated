...
extern_static!(ASWebAuthenticationSessionErrorDomain: &'static Foundation::NSErrorDomain);
...
pub type ASWebAuthenticationSessionCompletionHandler =
    *mut Block<(*mut Foundation::NSURL, *mut Foundation::NSError), ()>;
...
extern_protocol!(
    ...
    unsafe impl ProtocolType for ASWebAuthenticationPresentationContextProviding {
        ...
        pub unsafe fn presentationAnchorForWebAuthenticationSession(
            &self,
            session: &AuthenticationServices::ASWebAuthenticationSession,
