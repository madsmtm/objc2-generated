...
#[cfg(feature = "block2")]
pub type IOUSBHostCompletionHandler = block2::DynBlock<dyn Fn(IOReturn, NSUInteger)>;
...
pub type IOUSBHostIsochronousCompletionHandler =
    block2::DynBlock<dyn Fn(IOReturn, NonNull<IOUSBHostIsochronousFrame>)>;
...
pub type IOUSBHostIsochronousTransactionCompletionHandler =
    block2::DynBlock<dyn Fn(IOReturn, NonNull<IOUSBHostIsochronousTransaction>)>;
