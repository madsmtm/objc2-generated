...
impl SHSession {
    extern_methods!(
        ...
        /// ```
        ///
        /// You can use AsyncSequence operators like
        /// <doc
        /// ://com.apple.documentation/documentation/swift/asyncsequence/prefix(_:)>
        /// or
        /// <doc
        /// ://com.apple.documentation/documentation/swift/asyncsequence/first(where:)>
